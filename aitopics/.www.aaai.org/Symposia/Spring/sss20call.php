...
<title>AAAI 2020 Spring Symposia</title>
...
<div id="right">
<div id="box1"><a href="spring-symposia.php"><img src="http://www.aaai.org/Symposia/Spring/Photos/symposium.jpg" alt="Spring Symposium" width="638" height="343" border="0" /></a></div>
<div id="box6">
<h2 class="backgrnd12"><span class="text1">AAAI 2020 Spring Symposium Series</span></h2>
<div class="content">
<p><b>March 23&ndash;25, 2020</b></p>
...
<p><b>July 12, 2019: Proposals Due</b></p>
<p><a href="https://easychair.org/conferences/?conf=sss20" rel="nofollow">Proposal Submission Site</a></p>
<p>
AAAI invites proposals for the 2020 Spring Symposium Series, to be held Monday â¬ Wednesday, March 23-25 at Stanford University in Palo Alto, California. The Spring Symposium Series is an annual set of meetings run in parallel at a common site. It is designed to bring colleagues together in an intimate forum while at the same time providing a significant gathering point for the AI community. The two and one half day format of the series allows participants to devote considerably more time to feedback and discussion than typical one-day workshops. It is an ideal venue for bringing together new communities in emerging fields.
</p>
...
<p>
Proposals for symposia should be between two and five pages in length, and should contain the following information: 
</p>


<p><i>A title for the symposium.</i></p>
<p><i>A description of the symposium,</i>  identifying specific areas of interest, and general symposium format, as well as a preliminary outline of a proposed schedule.</p>
<p><i>The names and addresses (physical and electronic) of the organizing committee:</i> preferably three or more people at different sites, all of whom have agreed to serve on the committee.</p>
<p><i>A list of potential participants</i>  that have been contacted and that have expressed interest in participating. A common way of gathering potential participants is to send email messages to email lists related to the topic(s) of the symposium. Note that potential participants need not commit to participating, only state that they are interested.
</p>

<p>Ideally, the entire organizing committee should collaborate in producing the proposal. If possible, a draft proposal should be sent out to a few of the potential participants and their comments solicited. Approximately eight symposia on a broad range of topics within and around AI will be selected for the 2020 Spring Symposium Series.</p>

<p>The criteria for acceptance of proposals include the following:</p>

<p><i>Perceived interest to the AAAI community.</i> Although AAAI encourages symposia that cross disciplinary boundaries, a symposium must be of interest to some subcommunity of the AAAI membership. Symposia that are of interest to a broad range of AAAI members are also preferred. Appropriate number of potential participants. Although the series supports a range of symposium sizes, the target size is around 40-75 participants.  </p>
<p><i>Lack of a long-term ongoing series of activities on the topic.</i> The Spring Symposium Series is intended to nurture emerging communities and topics, so topics that already have yearly conferences or workshops are inappropriate. </p> 
<p><i>An appropriate organizing committee.</i> The organizing committee should have (1) good technical knowledge of the topic, (2) good organizational skills, and (3) connections to the various communities from which they intend to draw participants. Committees for cross-disciplinary symposia must adequately represent all the disciplines to be covered by the symposium. </p>

<p>Accepted proposals will be distributed as widely as possible over the subfields of AI, and balanced between theoretical and applied topics. Symposia bridging theory and practice and those combining AI and related fields are particularly solicited. 

<p>Symposium proposals should be submitted as soon as possible, but no later than July 12, 2019. Proposals that are submitted significantly before this deadline can be in draft form. Comments on how to improve and complete the proposal will be returned to the submitter in time for revisions to be made before the deadline. Notifications of acceptance or rejection will be sent to submitters around August 9, 2019. The submitters of accepted proposals will become the chair of the symposium, unless alternative arrangements are made. The symposium organizing committees will be responsible for the following tasks: 

</p>


<ul>
	<li>Writing short calls for participation and registration, which AAAI will distribute to its membership</li>
	<li>Additional publicity of the symposium, especially to potential audiences from outside the AAAI community</li>
	<li>Reviewing requests to participate in the symposium and determining symposium participants</li>
	<li>Submitting invitee and accepted author lists to facilitate registration</li>
	<li>Scheduling the activities of the symposium</li>
	<li>Preparing the (required) short review of the symposium, to be printed in <i>AI Magazine</i></li>
</ul>
<p>AAAI will provide logistical support and will take care of all local arrangements. </p>
<p>
Please submit your symposium proposals to the <a href="https://easychair.org/conferences/?conf=sss20">EasyChair submission site</a>  by the deadline (no postal submissions). Inquiries concerning the symposia may be directed to the symposium chair and cochair: 
</p>

<p>Christopher Geib (SIFT, USA) <br />
Ron Petrick (Heriot-Watt University, UK)<br />
SSS-20 Cochairs<br />
&#115;&#115;&#115;&#50;&#48;&#99;&#104;&#97;&#105;&#114;&#115;&#64;&#97;&#97;&#97;&#105;&#46;&#111;&#114;&#103;</p>

<p>All proposals will be reviewed by the AAAI Symposium Committee, including the cochairs, Associate Chair: Mike Genesereth (Stanford University), and AAAI Council Member, Claire Monteleone (George Washington University).</p>

<p>General inquiries regarding the symposium series should be directed to AAAI at &#115;&#115;&#115;&#50;&#48;&#64;&#97;&#97;&#97;&#105;&#46;&#111;&#114;&#103;.</p>
