...
<title>AAAI 2008 Spring Symposia</title>
...
<div id="box6">
<h2 class="backgrnd12"><span class="text1">AAAI 2008 Spring Symposium Series</span></h2>
<div class="content">


<p>The Association for the Advancement of Artificial Intelligence (AAAI) was pleased to present the AAAI 2008 Spring Symposium Series, to be held Wednesday through Friday, March 26&ndash;28, 2008 at Palo Alto, California.</p>

<p>The titles of the eight 
symposia were as follows:</p> 
<ul>
	<li>AI Meets Business Rules and Process Management</li>
	<li>Architectures for Intelligent Theory-Based Agents</li>
	<li>Creative Intelligent Systems</li>
	<li>Emotion, Personality, and Social Behavior</li>
	<li>Semantic Scientific Knowledge Integration</li>
	<li>Social Information Processing</li>
	<li>Symbiotic Relationships between Semantic Web and Knowledge Engineering</li>
	<li>Using AI to Motivate Greater Participation in Computer Science</li>
</ul>

<p>For more information about the 2008 AAAI Spring Symposium Series, you should consult the following:</p>
<ul>
<li><a href="http://www.aaai.org/Symposia/Spring/sss08proposals.pdf">Call for Proposals</a> (2008)</li> 
<li><a href="http://www.aaai.org/Symposia/Spring/sss08participation.pdf">Call for Participation</a> (2008)</li> 
<li><a href="http://www.aaai.org/Symposia/Spring/sss08participation-leaflet.pdf">Call for Participation Leaflet</a> (2008)</li> 
<li><a href="http://www.aaai.org/Symposia/Spring/sss08registration.pdf">Registration</a> (2008)</li>
<li><a href="http://www.aaai.org/Symposia/Spring/sss08registration-leaflet.pdf">Registration Leaflet</a> (2008)</li>
</ul>
