...
<title>AAAI 2019 Fall Symposium Series</title>
...
<div id="logo">
<h1>AAAI 2019 Fall Symposium Series</h1>
</div>
<!-- begin search -->
<div id="search">
...
<div id="box6">
<h2 class="backgrnd12"><span class="text1">AAAI 2019 Fall Symposium Series</span></h2>
<div class="content">

<h3>Call for Proposals</h3>

<p><i>Sponsored by the Association for the Advancement of Artificial Intelligence</i><br />Washington, DC,  November 7&ndash;-9, 2019 </p>

<ul>
	<li>Proposals Due: May 3</li>
	<li>Notifications to organizers: May 17</li>
	<li>Organizers submit and post CFPs: May 31</li>
	<li>Papers due to organizers: July 26</li>
	<li>Organizers send notifications to authors: August 16</li>
	<li>FSS final papers due to organizers: September 13 (recommended)</li>
	<li>Registration deadline: September 20</li>
</ul>
<div class="hr1">
<hr />
</div>
...
<p>
AAAI invites proposals for the 2019 Fall Symposium Series, to be held Thursday to Saturday, November 7&ndash;9 at the Westin Arlington Gateway in Arlington, Virginia adjacent to Washington, DC. The Fall Symposium Series provides the AI community with a unique venue in which researchers from different areas of AI can accomplish the following:
</p>

<ul>
	<li> Present speculative work and work in progress</li>
	<li> Hold focused discussions over several days</li>
	<li> Build new communities for emerging disciplines</li>
	<li>Build ties between existing disciplines</li>
</ul>


<p>
The series brings together a set of two and one-half day symposia at a common site, providing a unique and intimate forum for colleagues in a given discipline. Participants will be expected to attend a single symposium. The series also provides an important gathering point for the AI community as a whole. Efforts are made to encourage participation by graduate students. The series is designed to minimize the administrative burden on the organizing committees of the individual symposia. AAAI manages registration and local arrangements, and provides organizational support during the submission and review phase, as well as publicity within the AAAI community.
</p>

<p>
The series runs twice yearly (spring and fall). Approximately eight symposium topics will be selected for the 2019 Fall Symposium Series. Accepted proposals will be distributed as widely as possible over the subfields of AI, and balanced between theoretical and applied topics. Symposia bridging theory and practice and those combining AI and related fields are particularly solicited. 
</p>
<div class="hr1">
<hr />
</div>
...
<p>
<i>A title</i> for the symposium.
</p>

<p>
<i>A description of the symposium,</i>  identifying specific areas of interest, and, optionally, general symposium format. The symposia are intended to encourage presentation of speculative work and work in progress, as well as completed work. Therefore, ample time should be scheduled for discussion. Novel programming, including the use of target problems, open-format panels, working groups, or breakout sessions, is encouraged. 
</p>

<p>
<i>The names and (physical and electronic) addresses of the organizing committee, </i>preferably three or more people at different sites, all of whom have agreed to serve on the committee.
</p>

<p>
<i>A list of potential participants who have been contacted and who have expressed interest in participating.</i>  A common way of gathering potential participants is to send email messages to email lists related to the topic(s) of the symposium. Note that potential participants need not commit to participating, only state that they are interested.
</p>
...
<p>
Proposals will be reviewed by the Symposium Series Standing Committee (Chair: Christopher Geib, SIFT; Cochair: Ron Petrick, Heriot-Watt University; and Claire Monteleoni, George Washington University).
</p>
<div class="hr1">
<hr />
</div>
...
<p>
<i>Perceived interest to the AAAI community.</i> Although AAAI encourages symposia that cross disciplinary boundaries, a symposium must be of interest to some community within the AAAI membership. Symposia that are of interest to a broad range of AAAI members are, of course, also encouraged. Although the series supports a range of symposium sizes (roughly 25-75), the target size is around 40 participants. 
</p>


<p>
<i>Lack of established venues on the topic.</i>The AAAI Symposium Series is intended to nurture emerging communities and topics, so topics that already have yearly conferences or workshops are inappropriate. 
</p>

<p>
<i>Qualifications of the organizing committee.</i> The organizing committee should have (1) a good technical knowledge of the topic, (2) good organizational skills, and (3) connections to the various communities from which they intend to draw participants. Committees for cross-disciplinary symposia should adequately represent the disciplines to be covered by the symposium. 
</p>
<div class="hr1">
<hr />
</div>
...
<p>
Symposium proposals should be submitted as soon as possible, but no later than May 3, 2019. Proposals that are submitted significantly before this deadline can be in draft form. Comments on how to improve and complete the proposal will be returned to the submitter in time for revisions to be made before the deadline. Notifications of acceptance or rejection will be sent to submitters around May 17, 2019. 
</p>
...
<ul>
	...
	<li> Collecting submissions for distribution to symposium participants (and possible publication)</li>
	<li> Scheduling the activities of the symposium</li>
	<li> Preparing a short review of the symposium, to be printed in <i>AI Magazine.</i></li>
</ul>


<p>
Please submit your symposium proposals to the<a href="https://easychair.org/conferences/?conf=fss19" rel="nofollow"> EasyChair submission sit</a>e by the deadline (no postal submissions). Inquiries concerning the symposia may be directed to the symposium chair and cochair:
</p>

<p>
Christopher Geib (SIFT)
Ron Petrick (Heriot-Watt University)
FSS-19 Chair and Cochair
&#102;&#115;&#115;&#49;&#57;&#99;&#104;&#97;&#105;&#114;&#115;&#64;&#97;&#97;&#97;&#105;&#46;&#111;&#114;&#103;
</p>

<p>
General inquiries regarding the symposium series should be directed to AAAI by emailing &#102;&#115;&#115;&#49;&#57;&#99;&#104;&#97;&#105;&#114;&#115;&#64;&#97;&#97;&#97;&#105;&#46;&#111;&#114;&#103;.
</p>
