...
<title>AAAI 2014 Symposium on Educational Advances in Artificial Intelligence</title>
...
<div id="logo">
<h1>AAAI 2014 Symposium on Educational Advances in Artificial Intelligence</h1>
</div>
<!-- begin search -->
<div id="search">
...
<div id="right">
<div id="box1"><a href="eaai14.php"></a></div>
<div id="box6">
<h2 class="backgrnd12"><span class="text1">The Fifth Symposium on Educational Advances in Artificial Intelligence</span></h2>
<div class="content">
<p><i>Sponsored by the Association for the Advancement of Artificial Intelligence</i></p>

<p>The Association for the Advancement of Artificial Intelligence is pleased to present, in conjunction with the AAAI-14 Conference in Quebec City, Quebec, Canada, the Fifth Symposium on Educational Advances in Artificial Intelligence (EAAI-14), to be held July 28&ndash;29, 2014.</p>
<p><a href="http://eaai.cs.mtu.edu/" rel="nofollow">Supplementary Symposium Site</a></p>
<p>The Fifth Symposium on Educational Advances in Artificial Intelligence (EAAI-134) provides a venue for researchers and educators to discuss pedagogical issues and share resources related to teaching AI and using AI in education across a variety of curricular levels (K&ndash;12 through postgraduate training), with an emphasis on undergraduate and graduate teaching and learning.The symposium seeks contributions showing how to more effectively teach AI, as well as how themes from AI may be used to enhance education more broadly (for example, in introductory computing courses or as a means for teaching computational thinking). We encourage the sharing of innovative educational approaches that convey or leverage AI and its many sub-fields, including robotics, machine learning, natural language processing, computer vision</p>

<ul><li><a href="http://www.aaai.org/Symposia/EAAI/2014/eaai14call.php">Call for Participation</a></li></ul>


<h3>Symposium Technical Reports</h3> 
<p>Some AAAI symposia are available as technical reports. For contents and
ordering information, consult the symposium section of the <a href="../../Press/Reports/reports.php"> AAAI Press Technical Reports Catalog.</a></p>
<div class="hr1">
<hr />
</div>
