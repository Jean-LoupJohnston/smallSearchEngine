...
<title>AAAI 1991 Proceedings</title>
...
<div class="content">
<p><img height="144" width="110" src="http://www.aaai.org/Press/Proceedings/Covers/aaai91.jpg" alt="Proceedings Cover Image" style="float: left; margin-right: 5px;" /><b>AAAI-91<br />Anaheim, California</b><br />
955 pp., (in two volumes), references, index, illus., $100.00 softcover<br />
...
ISBN 978-0-262-51059-2<br />
<a href="http://www.aaai.org/cgi-bin/sc/order.cgi?storeid=*1eb18495ca0023947820c407d8ca61f695&dbname=products&itemnum=211&function=add">[Add to Cart]</a>&nbsp;<a href="http://www.aaai.org/cgi-bin/sc/order.cgi?storeid=*1eb18495ca0023947820c407d8ca61f695&function=show">[View Cart]</a>
</p>
<p>This proceedings is also part of the 1980&ndash;1997 Technical Papers 5 CD Set, available for $100.00<br /><a href="http://www.aaai.org/cgi-bin/sc/order.cgi?storeid=*20d8b94cf50031147aa20c607294c6e8f860&dbname=products&itemnum=642&function=add">Add to Cart]</a>&nbsp;<a href="http://www.aaai.org/cgi-bin/sc/order.cgi?storeid=*20d8b94cf50031147aa20c607294c6e8f860&function=show">[View Cart]</a></p><p><i>(Price quoted is for books manufactured in and shipped from USA. For shipment internationally, please see <a href="http://www.aaai.org/Press/orders.php#Shipping">Shipping Options)</a></i>

</p>

<p>The annual AAAI National Conference provides a forum for information exchange and interaction among researchers from all disciplines of AI. Contributions include theoretical, experimental, and empirical results. Topics cover case-based reasoning, case-based reasoning, transformation in design, communication and cooperation, education, user interfaces, generation and interaction, syntax and semantics, formalisms for coordination, multiagent architectures, constraint reasoning and component technologies, constraint-based reasoning, temporal constraints, extensions of truth maintenance, parallel support for rule-based systems, verification of rule-based systems, formal methods in knowledge representation, time and action, nonmonotonic reasoning, issues in automated reasoning, general deduction systems, search, terminological reasoning, belief functions, truth maintenance systems, learning, learning search control, learning theory and mdl, learning connectionist representations, learning and evaluation functions, planning, perception, and robotics, mathematical foundations of planning, path and assembly planning, hierarchy in planning, representation in planning, vision and sensor interpretation, sensing and reaction, robot learning, integration and recovery, reasoning about physical systems, qualitative analysis, diagnosis, aggregation and geometric reasoning, and tractable inference.</p>
