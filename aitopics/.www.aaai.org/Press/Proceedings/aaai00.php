...
<title>AAAI 2000 Proceedings</title>
...
Proceedings of the Seventeenth National Conference on Artificial Intelligence</span></h2>
<div class="content">
<p><img height="144" width="110" src="http://www.aaai.org/Press/Proceedings/Covers/aaai00.jpg" alt="Proceedings Cover Image" style="float: left; margin-right: 5px;" /><b>AAAI-00<br />Austin Texas</b><br />1,226 pp., references, index, illus., $100.00 softcover<br />
...
<p>A CD version of the proceedings is also available for $39.00 (ISBN 978-1-57735-272-3)<br />
...
<p>The annual AAAI National Conference and Innovative Applications of
Artificial Intelligence Conference provide a forum for information
exchange and interaction among researchers from all disciplines of AI.
Contributions include theoretical, experimental, and empirical
results.</p>
<p>The technical papers published in this proceedings were selected by a
rigourous, double-blind review process. The National Conference papers
cover a myriad of topics, including agents, artificial intelligence and
the world wide web, cognitive systems, constraint satisfaction problems,
knowledge acquisition, knowledge representation, learning, model-based
reasoning, natural language and information retrieval, planning,
robotics, satisfiability, scheduling, search, tractable reasoning, and
vision.</p>
<p> The Innovative Applications Conference papers feature
deployed and emerging applications. These papers will be of special
benefit to AI applications developers. In addition, abstracts from the
Invited Talks, Intelligent Systems Demonstrations, Robotic Competition
and Exhibition, SIGART/AAAI Doctoral Consortium, and Student programs
are also included in this proceedings.</p>
