...
<title>AAAI 2010 Proceedings</title>
...
Proceedings of the Twenty-Fourth AAAI Conference on Artificial Intelligence</span></h2>
<div class="content">
<p><img height="176" width="131" src="http://www.aaai.org/Press/Proceedings/Covers/aaai10.jpg" alt="Proceedings Cover Image" style="float: left; margin-right: 5px;" /><b>AAAI-10, Atlanta, Georgia</b><br />
3 vols., references, index, illus., $220.00 softcover<br />
...
ISBN 978-1-57735-463-5<br />
<a href="http://www.aaai.org/cgi-bin/sc/order.cgi?storeid=*183ce0c4094a21689270f8d74000&dbname=products&itemnum=702&function=add">[Add to Cart]</a>&nbsp;<a href="http://www.aaai.org/cgi-bin/sc/order.cgi?storeid=*183ce0c4094a21689270f8d74000&function=show">[View Cart]</a>

</p>
<p>A CD version of the proceedings is also available for $39.00 (978-1-57735-462-8)<br />
<a href="http://www.aaai.org/cgi-bin/sc/order.cgi?storeid=*143c9a200fc94087086124cc&dbname=products&itemnum=701&function=add">[Add to Cart]</a>&nbsp;<a href="http://www.aaai.org/cgi-bin/sc/order.cgi?storeid=*143c9a200fc94087086124cc&function=show">[View Cart]</a>

</p>


<p>For almost three decades the AAAI Conference on Artificial Intelligence&mdash;AAAI's summer conference&mdash;has promoted theoretical and applied AI research as well as intellectual interchange among researchers and practitioners. The technical papers presented at this conference feature substantial, original research and practices, with special emphasis on 
constratins, satisfiability, and search, knowledge-based information systems, knwoeldge representation and reasoning, machine learning, multiagent systems, multidisciplinary topics, natural-language processing, reasoning about plans, processes, and actions, reasoning under uncertainty, robotics, and short papers. The proceedings also includes special track papers on bioinformations, AI and the web, challenges in AI, integrated intelligence, and physically grounded AI. The volumes also includes papers presented by senior AAAI members, new scientific and technical advances in research papers, doctoral consortium and student abstracts.</p>
<p>This proceedings also includes the papers presented at the Innovative Applications of Artificial Intelligence Conference. The IAAI conference traditionally consists of case studies of deployed applications with measurable benefits whose value depends on the use of AI technology, as well as emerging applications, which discuss efforts to apply AI tools, techniques, or methods to real world problems. Through the IAAI papers in this proceedings, AI researchers can learn about challenges of real-world domains, the utility of particular AI techniques for specific applications, and the difficulties, successes, and lessons learned in deploying AI applications.</p>
<p>Included also, this year for the first time, are papers from the First Annual AAAI Symposium on Education Advances in AI. 
<p> Both conferences and the symposium are sponsored by the Association for the Advancement of Artificial Intelligence.</p>
