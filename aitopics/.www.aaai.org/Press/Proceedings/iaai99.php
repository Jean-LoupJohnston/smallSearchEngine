...
<title>IAAI 1999 Proceedings</title>
...
Proceedings of the Eleventh Conference on Innovative Applications of Artificial Intelligence</span></h2>
<div class="content">
<p><img height="144" width="110" src="http://www.aaai.org/Press/Proceedings/Covers/iaai99.jpg" alt="Proceedings Cover Image" style="float: left; margin-right: 5px;" /><b><i>Edited by Ramasamy Uthurusamy  and Barbara Hayes-Roth</i></b><br />
...
<p>The Eleventh Annual Conference on Innovative Applications of Artificial Intelligence (IAAI-99) continues the IAAI tradition of case studies of deployed applications with measurable benefits whose value depends on the use of AI technology. In addition, IAAI-99 augments these case studies with papers and invited talks that address emerging areas of AI technology or applications. IAAI is organized as an independent program within the National Conference, with schedules coordinated to allow attendees to move freely between IAAI and National Conference sessions. IAAI and the National Conference papers are published in a joint Proceedings.</p>
<p>IAAI-99 deployed applications papers are case studies that provide a valuable guide to designing, building, managing, and deploying systems incorporating AI technologies. These applications provide clear evidence of the impact and value that AI technology has in today's world.</p>
<p>Papers in the Emerging Applications and Technologies track describe efforts whose goal is the engineering of AI applications. They inform AI researchers about the utility of specific AI techniques for applications domains and also inform applications developers about tools and techniques that will enable the next generation of new and more powerful applications.</p> <p>This year's papers address applications in education, the military, networking, spacecraft, medicine, games, the stock market, and more. AI techniques include, among others, planning, natural language processing, diagnostic reasoning, and cognitive simulation.</p>
