...
<title>ICWSM 2008 Proceedings</title>
...
Proceedings of the Second International Conference on Weblogs and Social Media</span></h2>
<div class="content">
<p><img height="150" width="114" src="http://www.aaai.org/Press/Proceedings/Covers/icwsm08.jpg" alt="Proceedings Cover Image" style="float: left; margin-right: 5px;" /><br />
260 pp., references, index, illus., $45.00 softcover<br />
...
ISBN 978-1-57735-355-3<br />
<a href="http://www.aaai.org/cgi-bin/sc/order.cgi?storeid=*1eb18495ca0023947820c407d8ca61f695&dbname=products&itemnum=182&function=add">[Add to Cart]</a>&nbsp;<a href="http://www.aaai.org/cgi-bin/sc/order.cgi?storeid=*1eb18495ca0023947820c407d8ca61f695&function=show">[View Cart]</a>
</p>
<p>A CD version of the proceedings is also available for $39.00 (ISBN 978-1-57735-356-0)<br />
<a href="http://www.aaai.org/cgi-bin/sc/order.cgi?storeid=*1eb18495ca0023947820c407d8ca61f695&dbname=products&itemnum=579&function=add">[Add to Cart]</a>&nbsp;<a href="http://www.aaai.org/cgi-bin/sc/order.cgi?storeid=*1eb18495ca0023947820c407d8ca61f695&function=show">[View Cart]</a>
</p>

<p>The rapid creation and consumption of social media content continues to drive the evolution of the Internet and the Web. Social media content now accounts for the majority of content published daily online, eclipsing professional web content. ICWSM is the premier conference for researchers and industrialists to gather, share research findings and explore this exciting space. Following in the tradition of earlier workshops and the first full meeting in Boulder, USA in 2007, the 2008 conference bought together academic and industrial practitioners to present and to discuss new research, applications, thoughts and ideas that are shaping the future of social media analysis.</p>

<p>The conference has grown and we are now proud to be one of a number of prestigious events supported by the Association for the Advancement of Artificial Intelligence. The founders of the conference view social media, the social web and social networks as being the next major transformation of the web &mdash; in fact the realization of the original vision for the web in many ways. The impact of these changes affects not only society's interactions mediated online, but society in general and therefore represents a fundamentally important area of research. The space produces large quantities of data and relationships which benefit AI research in two major ways. First, because there is huge value in automating the analysis of social content, and second, because in creating technologies to understand the social web, we will gain insight into the personal and social mechanisms involved &mdash; reflecting one of the principle goals of the AI research agenda.</p>
