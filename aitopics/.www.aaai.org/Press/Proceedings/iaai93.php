...
<title>IAAI 1993 Proceedings</title>
...
Proceedings of the Fifth Conference on Innovative Applications of Artificial Intelligence</span></h2>
<div class="content">
<p><img height="144" width="110" src="http://www.aaai.org/Press/Proceedings/Covers/iaai93.jpg" alt="Proceedings Cover Image" style="float: left; margin-right: 5px;" /><b><i>Edited by Phil Klahr  and Elizabeth Byrnes</i></b><br />
202 pp., references, index, illus., $45.00 softcover<br />
...
ISBN 978-0-929280-46-2<br />
<a href="http://www.aaai.org/cgi-bin/sc/order.cgi?storeid=*1eb18495ca0023947820c407d8ca61f695&dbname=products&itemnum=261&function=add">[Add to Cart]</a>&nbsp;<a href="http://www.aaai.org/cgi-bin/sc/order.cgi?storeid=*1eb18495ca0023947820c407d8ca61f695&function=show">[View Cart]</a>
</p>

<p>Books in the innovative applications of artificial intelligence (IAAI) series report on the nature and range of real-world problems that AI technology can address successfully today. All of the contributions in these books have a practical slant, showing how AI has been successfully applied to a wide spectrum of domains and tasks. They provide an excellent sampling of the types of applications coming on line.</p>
<p>The applications selected this year continue to illustrate the maturity of AI as a commercially viable set of technologies. AI has infiltrated a huge number of companies around the world and has enabled those companies to solve significant business problems and achieve major business benefits. This year's IAAI applications represent a cross-section of large-scale organizations and tasks. Industries represented include computers, telecommunications, aerospace, automotive, paper/pulp, energy, as well as government agencies. Functions that have been AI-automated range from enterprise-wide administrative workflow to software design, from automotive process planning and cost estimation to finished goods inspection. They cover product and facilities design, customer service, diagnosis, quality management, and production. As a whole, the applications show the continued movement of AI into critical core business functions.</p>
