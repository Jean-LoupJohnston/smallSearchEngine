...
<title>IAAI 2009 Proceedings</title>
...
Proceedings of the Twenty-First Conference on Innovative Applications of Artificial Intelligence</span></h2>
<div class="content">
<p><img height="144" width="110" src="http://www.aaai.org/Press/Proceedings/Covers/iaai09.jpg" alt="Proceedings Cover Image" style="float: left; margin-right: 5px;" /><b><i>Edited by Karen Haigh
and Nestor Rychtyckjy</i></b><br />
236, references, index, illus., $45.00 softcover<br />
...
ISBN 978-1-57735-423-9<br />
<a href="http://www.aaai.org/cgi-bin/sc/order.cgi?storeid=*183ce0c4094a21689270f8d74000&dbname=products&itemnum=657&function=add">[Add to Cart]</a>&nbsp;<a href="http://www.aaai.org/cgi-bin/sc/order.cgi?storeid=*183ce0c4094a21689270f8d74000&function=show">[View Cart]</a>

</p>
<p>A CD version of the proceedings is also available for $39.00 (978-1-57735-424-6)<br />
<a href="http://www.aaai.org/cgi-bin/sc/order.cgi?storeid=*183ce0c4094a21689270f8d74000&dbname=products&itemnum=656&function=add">[Add to Cart]</a>&nbsp;<a href="http://www.aaai.org/cgi-bin/sc/order.cgi?storeid=*183ce0c4094a21689270f8d74000&function=show">[View Cart]</a>

>
</p>

<p>IAAI showcases applications of two types: deployed and emerging. Deployed applications are currently utilized by end-users to solve real problems in their domains. They are case studies that provide working guidelines on designing, building, managing, and fielding systems that incorporate AI technologies. This year there are four deployed applications. These applications provide clear evidence of the impact and value of AI technology in today's world. Papers on Emerging Applications and Technologies describe efforts whose goal is the engineering of AI applications. They inform researchers about the utility of specific AI methods for application domains and also inform application developers about the emerging tools and techniques that will enable the next generation of new applications. IAAI-09 is organized as an independent program within the IJCAI-09 Conference, with schedules coordinated to allow attendees to move freely between IJCAI and IAAI sessions. This volume presents the proceedings of the latest conference, held in July, 2009 in Pasadena, California USA.</p>
