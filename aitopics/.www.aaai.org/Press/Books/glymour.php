...
<title>Computation, Causation, and Discovery</title>
...
<div id="logo">
<h1>Computation, Causation, and Discovery</h1>
</div>
<!-- begin search -->
<div id="search">
...
Computation, Causation, and Discovery</span></h2>
<div class="content">
<p><img height="107" width="72" src="http://www.aaai.org/Press/Books/Covers/glymour.jpg" alt="Book Cover Image" style="float: left; margin-right: 5px;" /><b>Edited by Clark Glymour and Gregory Cooper</b><br />
426 pp., references, index, illus., $55.00 softcover, ISBN 978-0-262-57124-1<br />
<a href="http://www.aaai.org/cgi-bin/sc/order.cgi?storeid=*1eb18495ca0023947820c407d8ca61f695&dbname=products&itemnum=229&function=add">[Add to Cart]</a>&nbsp;<a href="http://www.aaai.org/cgi-bin/sc/order.cgi?storeid=*1eb18495ca0023947820c407d8ca61f695&function=show">[View Cart]</a>
</p>

<p>In science, business, and policymaking&mdash;anywhere data are used in prediction&mdash;two sorts of problems requiring very different methods of analysis often arise. The first, problems of recognition and classification, concerns learning how to use some features of a system to accurately predict other features of that system. The second, problems of causal discovery, concerns learning how to predict those changes to some features of a system that will result if an intervention changes other features. This book is about the second&mdash;much more difficult&mdash;type of problem.</p>
<p>Typical problems of causal discovery are: How will a change in commission rates affect the total sales of a company? How will a reduction in cigarette smoking among older smokers affect their life expectancy? How will a change in the formula a college uses to award scholarships affect its dropout rate? These sorts of changes are interventions that directly alter some features of the system and perhaps&mdash;and this is the question-&mdash;indirectly alter others.</p>
<p>The contributors discuss recent research and applications using Bayes nets or directed graphic representations, including representations of feedback or recursive systems. The book contains a thorough discussion of foundational issues, algorithms, proof techniques, and applications to economics, physics, biology, educational research, and other areas.</p>
<p><i>Clark Glymour</i> is Alumni University Professor at Carnegie Mellon University and Valtz Family Professor of Philosophy at the University of California, San Diego.</p> <p><i>Gregory F. Cooper</i> is Associate Professor of Medicine and Intelligent Systems at the University of Pittsburgh, where he is also Senior Associate in the Center for Biomedical Informatics.</p>
