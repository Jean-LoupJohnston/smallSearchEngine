...
<title>Case-Based Reasoning: Experiences, Lessons, and Future Directions</title>
...
<div id="logo">
<h1>Case-Based Reasoning: Experiences, Lessons, and Future Directions</h1>
</div>
<!-- begin search -->
<div id="search">
...
Case-Based Reasoning: Experiences, Lessons, and Future Directions</span></h2>
<div class="content">
<p><img height="107" width="72" src="http://www.aaai.org/Press/Books/Covers/leake.jpg" alt="Book Cover Image" style="float: left; margin-right: 5px;" /><b>Edited by David B. Leake</b><br />
435 pp., references, index, illus., $50.00 softcover, ISBN 978-0-262-62110-6<br />
<a href="http://www.aaai.org/cgi-bin/sc/order.cgi?storeid=*1eb18495ca0023947820c407d8ca61f695&dbname=products&itemnum=237&function=add">[Add to Cart]</a>&nbsp;<a href="http://www.aaai.org/cgi-bin/sc/order.cgi?storeid=*1eb18495ca0023947820c407d8ca61f695&function=show">[View Cart]</a>
</p>

<p>Case-based reasoning (CBR) is a flourishing paradigm for reasoning and learning in artificial intelligence, with major research efforts and burgeoning applications extending the frontiers of the field. </p>
<p>This book provides an introduction for students as well as an up-to-date overview for experienced researchers and practitioners. It examines the field in a "case-based" way, through concrete examples of how key issues&mdash;including indexing and retrieval, case adaptation, evaluation, and application of CBR methods&mdash;are being addressed in the context of a range of tasks and domains. Complementing these case studies are commentaries by leading researchers on the lessons learned from experiences with CBR and visions for the roles in which case-based reasoning can have the greatest impact. </p>
<p>This book presents a selection of recent progress, issues, and directions for the future of case-based reasoning. It includes chapters addressing fundamental issues and approaches in indexing and retrieval, situation assessment and similarity assessment, and in case adaptation. Those chapters provide a "case-based" view of key problems and solutions in context of the tasks for which they were developed. It also presents lessons learned about how to design CBR systems and how to apply them to real-world problems. The final chapters include a perspective on the state of the field and the most important directions for future impact. The case studies presented involve a broad sampling of tasks, such as design, education, legal reasoning, planning, decision support, problem-solving, and knowledge navigation. In addition, they experimentally examine one of the fundamental tenets of CBR, that storing experiences improves performance. The chapters also address other issues that, while not restricted to CBR per se, have been vigorously attacked by the CBR community, including creative problem-solving, strategic memory search, and opportunistic retrieval. This volume provides a vision of the present, and a challenge for the future, of case-based reasoning research and applications.</p>
<p>David Leake has also compiled a list of <a href="http://www.aaai.org/Resources/cbr-resources.php">case-based
reasoning resources</a> that is maintained by AAAI. (This
resource list is also contained in the book.)</p>
