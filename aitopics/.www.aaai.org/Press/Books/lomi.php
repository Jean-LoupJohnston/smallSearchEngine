...
<title>Dynamics of Organizations: Computational Modeling and Organization Theories</title>
...
<div id="logo">
<h1>Dynamics of Organizations: Computational Modeling and Organization Theories</h1>
</div>
<!-- begin search -->
<div id="search">
...
Dynamics of Organizations: Computational Modeling and Organization Theories</span></h2>
<div class="content">
<p><img height="107" width="72" src="http://www.aaai.org/Press/Books/Covers/lomi.jpg" alt="Book Cover Image" style="float: left; margin-right: 5px;" /><b>Edited by Alessandro Lomi and Erik R. Larsen</b><br />
525 pp., references, index, illus., $42.00 softcover, 
ISBN 978-0-262-62152-6<br />
<a href="http://www.aaai.org/cgi-bin/sc/order.cgi?storeid=*1eb18495ca0023947820c407d8ca61f695&dbname=products&itemnum=238&function=add">[Add to Cart]</a>&nbsp;<a href="http://www.aaai.org/cgi-bin/sc/order.cgi?storeid=*1eb18495ca0023947820c407d8ca61f695&function=show">[View Cart]</a>
</p>

<p>An organization is more than the sum of its parts, and the individual components that function as a complex social system can be understood only by analyzing their collective behavior. This book shows how state-of-the-art simulation methods, including genetic algorithms, neural networks, and cellular automata, can be brought to bear on central problems of organizational theory related to the emergence, permanence, and dissolution of hierarchical macrostructures. The emphasis is on the application of a new generation of equation- and agent-based computational models that can help students of organizations to reformulate their basic research questions starting from assumptions about how to link &mdash; rather than separate &mdash; different levels of organizational analysis.</p>
<p><b>Alessandro Lomi</b> is a professor of organizational theory and behavior at the School of Economics, University of Bologna.</p>
<p><b>Erik R. Larsen</b> is a professor of management at City University Business School, London.</p>
<h4>Contributors</h4>
<p>David Barron, Matthew S. Bothner, Richard M. Burton, Kathleen M. Carley, Glenn Carroll, Michael T. Hannan, Richard Harrison, Vanessa Hill, Bernardo A. Huberman, David M. Krackhardt, Erik R. Larsen, Daniel Levinthal, Christoph H. Loch, Alessandro Lomi, Michael Macy, Franco Malerba, James G. March, John H. Miller, Richard Nelson, Luigi Orsenigo, Laszlo P&oacute;los, Michael J. Prietula, Anjali Sastry, David Strang, Sezer &Uuml;lk&uuml;, Harrison C. White, Sidney G. Winter.</p>
