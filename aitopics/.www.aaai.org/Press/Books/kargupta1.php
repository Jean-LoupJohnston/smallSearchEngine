...
<title>Advances in Distributed and Parallel Knowledge Discovery</title>
...
<div id="logo">
<h1>Advances in Distributed and Parallel Knowledge Discovery</h1>
</div>
<!-- begin search -->
<div id="search">
...
Advances in Distributed and Parallel Knowledge Discovery</span></h2>
<div class="content">
<p><img height="107" width="72" src="http://www.aaai.org/Press/Books/Covers/kargupta1.jpg" alt="Book Cover Image" style="float: left; margin-right: 5px;" /><b>Edited by Hillol Kargupta and Philip Chan</b><br />
472 pp., references, index, illus., $55.00 softcover, ISBN 978-0-262-61155-8<br />
<a href="http://www.aaai.org/cgi-bin/sc/order.cgi?storeid=*1eb18495ca0023947820c407d8ca61f695&dbname=products&itemnum=233&function=add">[Add to Cart]</a>&nbsp;<a href="http://www.aaai.org/cgi-bin/sc/order.cgi?storeid=*1eb18495ca0023947820c407d8ca61f695&function=show">[View Cart]</a>
</p>

<p>Knowledge discovery and data mining (KDD) deals with the problem of extracting interesting associations, classifiers, clusters, and other patterns from data. The emergence of network-based distributed computing environments has introduced an important new dimension to this problem&mdash;distributed sources of data. Traditional centralized KDD typically requires central aggregation of distributed data, which may not always be feasible because of limited network bandwidth, security concerns, scalability problems, and other practical issues. Distributed knowledge discovery (DKD) works with the merger of communication and computation by analyzing data in a distributed fashion. This technology is particularly useful for large heterogeneous distributed environments such as the Internet, intranets, mobile computing environments, and sensor-networks.</p> <p>When the datasets are large, scaling up the speed of the KDD process is crucial. Parallel knowledge discovery (PKD) techniques address this problem by using high performance multi-processor machines. This book presents introductions to DKD and PKD, extensive reviews of the field, and state-of-the-art techniques.</p>
