...
<div id="logo">
<h1>Advances in Knowledge Discovery and Data Mining</h1>
</div>
<!-- begin search -->
<div id="search">
...
Advances in Knowledge Discovery and Data Mining</span></h2>
<div class="content">
<p><img height="107" width="72" src="http://www.aaai.org/Press/Books/Covers/fayyad.jpg" alt="Book Cover Image" style="float: left; margin-right: 5px;" /><b>Edited by Usama M. Fayyad, Gregory Piatetsky-Shapiro, Padhraic Smyth, and Ramasamy Uthurusamy</b><br />
625 pp., references, index, illus., $62.00 softcover, ISBN 978-0-262-56097-9<br />
<a href="http://www.aaai.org/cgi-bin/sc/order.cgi?storeid=*1eb18495ca0023947820c407d8ca61f695&dbname=products&itemnum=224&function=add">[Add to Cart]</a>&nbsp;<a href="http://www.aaai.org/cgi-bin/sc/order.cgi?storeid=*1eb18495ca0023947820c407d8ca61f695&function=show">[View Cart]</a>
</p>

<p>During the last decade, we have seen an explosive growth in our capabilities to both generate and collect data. Advances in data collection, widespread use of bar codes for most commercial products, and the computerization of many business and government transactions have flooded us with information, and generated an urgent need for new techniques and tools that can intelligently and automatically assist us in transforming this data into useful knowledge. This book examines and describes many such new techniques and tools, in the emerging field of data mining and knowledge discovery in databases (KDD).</p>
<p>The chapters of this book span fundamental issues of knowledge discovery, classification and clustering, trend and deviation analysis, dependency derivation, integrated discovery systems, augmented database systems, and application case studies.</p>
<p><i>Advances in Knowledye Discovery and Data Mining</i> brings together the latest research&mdash;in statistics, databases, machine learning, and artificial intelligence&mdash;that are part of the exciting and rapidly growing field of knowledge discovery and data mining. Topics covered include fundamental issues, classification and clustering, trend and deviation analysis, dependency modeling, integrated discovery systems, next generation database systems, and application case studies. The contributors include leading researchers and practitioners from academia, government laboratories, and private industry.</p> <p>Advances in data collection, widespread use of bar codes for most commercial products, and the computerization of many business and government transactions have flooded us with data and generated an urgent need for new techniques and tools that can intelligently and automatically assist in transforming this data into useful knowledge. This book is a timely and comprehensive overview of the new generation of techniques and tools for knowledge discovery in data.</p>
