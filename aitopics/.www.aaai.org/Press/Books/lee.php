...
<title>Intelligence and Multimodality in Multimedia Interfaces: Research and Applications</title>
...
<div id="logo">
<h1>Intelligence and Multimodality in Multimedia Interfaces: Research and Applications</h1>
</div>
<!-- begin search -->
<div id="search">
...
Intelligence and Multimodality in Multimedia Interfaces: Research and Applications</span></h2>
<div class="content">
<p><img height="107" width="72" src="http://www.aaai.org/Press/Books/Covers/lee.jpg" alt="Book Cover Image" style="float: left; margin-right: 5px;" /><b>Edited by John Lee</b><br />
19 chapters, 9 multimedia clips, 2 sound clips, electronic 
index; PDF, QuickTime, and MOOV format. <br />CD: $29.95, <i>This book 
is available in CD format only.</i><br />
978-1-57735-260-0<br />
<a href="http://www.aaai.org/cgi-bin/sc/order.cgi?storeid=*1eb18495ca0023947820c407d8ca61f695&dbname=products&itemnum=16&function=add">[Add to Cart]</a>&nbsp;<a href="http://www.aaai.org/cgi-bin/sc/order.cgi?storeid=*1eb18495ca0023947820c407d8ca61f695&function=show">[View Cart]</a>

<p>Very little in computing these days is promoted with as much vigor as multimedia. Multimedia, we are told, will increase the usability and productivity of systems; it will improve the ability of people to learn from educational applications; it will combine naturally with other interface technologies to create a more natural interaction than ever before.</p> <p>Most of what we see, however, falls well short of these expectations. The majority of multimedia systems are little more than a means of stringing together pre-packaged information which, almost incidentally, may take the form of images, sound or video clips, as well as simple text. The structure behind the presentation is usually limited to a hypertext network, where video clips, etc. can be the items at the nodes (which we are now used to calling "hypermedia"). Such systems are inevitably limited in their ability to respond to the needs of the user; they are often complicated and expensive to create; they are also complicated and expensive to change once created. To make good on the promises of the hype&mdash;if it is possible at all&mdash;we will have to develop systems that are much more responsive and adaptable (automatically or otherwise).</p> <p>The nineteen chapters in this electronic book, in one way or another, address issues that arise in this context. They derive from presentations given at IMMI-1, the First International Workshop on Intelligence and Multimodality in Multimedia Interfaces, held in Edinburgh,Scotland, specifically to examine the prospects for such developments, and to identify pointers for promising research. </p> <p> Some of these chapters tackle technical problems in improving the responsiveness and adaptiveness of systems, while others are directed more towards design and evaluation of the presentations and interactions that users will need. Both of these perspectives are of course equally important.The chapters in this book are divided into sections on multimedia and multimodality, multimodality and natural language, theoretical and formal approaches to multimodality, system designs based on Users' intentions and expectations, and methodologies for multimodal system design, and cognitive approaches and evaluation.</p>
