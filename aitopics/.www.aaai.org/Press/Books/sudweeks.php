...
<title>Network and Netplay: Virtual Groups on the Internet</title>
...
<div id="logo">
<h1>Network and Netplay: Virtual Groups on the Internet</h1>
</div>
<!-- begin search -->
<div id="search">
...
Network and Netplay: Virtual Groups on the Internet</span></h2>
<div class="content">
<p><img height="107" width="72" src="http://www.aaai.org/Press/Books/Covers/sudweeks.jpg" alt="Book Cover Image" style="float: left; margin-right: 5px;" /><b>Edited by Fay Sudweeks, Margaret McLaughlin, and Sheizaf Rafaeli</b><br />
333 pp., bibliography, index, illus., $40.00 softcover, ISBN 978-0-262-69206-9<br />
<a href="http://www.aaai.org/cgi-bin/sc/order.cgi?storeid=*1eb18495ca0023947820c407d8ca61f695&dbname=products&itemnum=246&function=add">[Add to Cart]</a>&nbsp;<a href="http://www.aaai.org/cgi-bin/sc/order.cgi?storeid=*1eb18495ca0023947820c407d8ca61f695&function=show">[View Cart]</a>
</p>

<p>The vast, international web of computer networks that is the Internet offers millions of users the opportunity to exchange electronic mail, photographs, and sound clips; to search databases for books, CDs, cars, and term papers; to participate in real-time audio-and video-conferencing; and to shop for products both virtual and physical. This huge conglomerate of links, hyperlinks, and virtual links is not just a technology for linking computers&mdash;it is a medium for communication.</p>
<p>The convergence of computer and communication technologies creates a social convergence as well. People meet in chat rooms and discussion groups to converse on everything from auto mechanics to post-modern art; networked groups form virtually and on-the-fly, as common interests dictate. Like interpersonal communication, the networks are participatory, their content made up by their audience. Like mass-mediated communication, they involve large audiences. But the networks are neither purely interpersonal nor purely mass&mdash;they are a new phenomenon.</p>
<p><i>Network and Netplay</i> addresses the mutual influences between information technology and group information and development, to assess the impact of computer-mediated communications on both work and play. Areas discussed include the growth and features of the Internet, network norms and experiences, and the essential nature of network communications.</p>
