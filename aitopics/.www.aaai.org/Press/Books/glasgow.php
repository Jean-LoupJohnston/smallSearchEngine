...
<title>Diagrammatic Reasoning: Cognitive and Computational Perspectives</title>
...
<div id="logo">
<h1>Diagrammatic Reasoning: Cognitive and Computational Perspectives</h1>
</div>
<!-- begin search -->
<div id="search">
...
Diagrammatic Reasoning: Cognitive and Computational Perspectives</span></h2>
<div class="content">
<p><img height="107" width="72" src="http://www.aaai.org/Press/Books/Covers/glasgow.jpg" alt="Book Cover Image" style="float: left; margin-right: 5px;" /><b>Edited by Janice Glasgow, N. Hari Narayanan, and B. Chandrasekaran.<br />Foreword by Herbert Simon</b><br />
807 pp., references, index, illus., $75.00 softcover, ISBN 978-0-262-57112-8<br />
<a href="http://www.aaai.org/cgi-bin/sc/order.cgi?storeid=*1eb18495ca0023947820c407d8ca61f695&dbname=products&itemnum=228&function=add">[Add to Cart]</a>&nbsp;<a href="http://www.aaai.org/cgi-bin/sc/order.cgi?storeid=*1eb18495ca0023947820c407d8ca61f695&function=show">[View Cart]</a>
</p>

<p>Diagrammatic reasoning&mdash;the understanding of concepts and ideas by the use of diagrams and imagery, as opposed to linguistic or algebraic representations&mdash;not only allows us to gain insight into the way we think, but is a potential base for constructing representations of diagrammatic information that can be stored and processed by computers.</p>
<p><i>Diagrammatic Reasoning</i> brings together nearly two dozen recent investigations into the cognitive, the logical, and particularly the computational, characteristics of diagrammatic representations and the reasoning that can be done with them. Following a foreword by Herbert Simon (coauthor of one of the most influential papers on reasoning with diagrams which is included here), and an introduction by the editors, chapters provide an overview of the recent history of the subject, survey and extend the underlying theory of diagrammatic representation, and provide numerous examples of diagrammatic reasoning (human and mechanical) that illustrate both its powers and its limitations. Each of the book's four sections begins with an introduction by an eminent researcher who provides an interesting personal perspective while also placing the work in proper context.</p>
