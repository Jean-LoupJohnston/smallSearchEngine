...
<title>Smart Machines in Education</title>
...
<div id="logo">
<h1>Smart Machines in Education</h1>
</div>
<!-- begin search -->
<div id="search">
...
Smart Machines in Education</span></h2>
<div class="content">
<p><img height="107" width="72" src="http://www.aaai.org/Press/Books/Covers/forbus.jpg" alt="Book Cover Image" style="float: left; margin-right: 5px;" /><b>Edited by Kenneth D. Forbus and Paul J. Feltovich</b><br />
500 pp., references, index, illus., $48.00 softcover, ISBN 978-0-262-56141-9<br />
<a href="http://www.aaai.org/cgi-bin/sc/order.cgi?storeid=*1eb18495ca0023947820c407d8ca61f695&dbname=products&itemnum=226&function=add">[Add to Cart]</a>&nbsp;<a href="http://www.aaai.org/cgi-bin/sc/order.cgi?storeid=*1eb18495ca0023947820c407d8ca61f695&function=show">[View Cart]</a>
</p>

<p>Multimedia, simulation, computer-mediated communication networks, and distance learning have all become part of the educational toolkit. The next major technology to change the face of education will be based on the widespread use of artificial intelligence (AI). Progress in AI has led to a deeper understanding of how to represent knowledge, to reason, and to describe procedural knowledge. Progress in cognitive science has led to a deeper understanding of how people think, solve problems, and learn. AI scientists use results from cognitive science to create software with more humanlike abilities, which can help students learn better.</p>
<p>This book looks at some of the results of this synergy among AI, cognitive science, and education. Examples include virtual students whose misconceptions force students to reflect on their own knowledge, intelligent tutoring systems, and speech recognition technology that helps students learn to read. Some of the systems described are already used in classrooms and have been evaluated; a few are still laboratory efforts. The book also addresses cultural and political issues involved in the deployment of new educational technologies.</p>
<p><b>Kenneth D. Forbus</b> is Professor of Computer Science and Education at Northwestern University. He is a coauthor of <i>Building Problem Solvers</i> (MIT Press, 1993).</p>
<p><b>Paul J. Feltovich</b> is Professor of Medical Education and Psychiatry at Southern Illinois University School of Medicine. He is the coeditor of <a href="feltovich.php"><i>Expertise in Context</i></a> (AAAI Press/MIT Press, 1997).</p>
<h4>Contributors</h4>
<p>Gregory Aist, Joseph Beck, Kirstie L. Bellman, Gautam Biswas, Lisa M. Bouillion, John Bransford, Bert Bredeweg, Charles B. Callaway, John Connelly, Richard Coulson, Kees de Koning, Christopher Eliot, Paul J. Feltovich, Kenneth D. Forbus, Louis M. Gomez, Jo&euml;l P. Gr&eacute;goire, Kenneth R. Koedinger, Alan Lesgold, James C. Lester, Jack Mostow, Adam Neaman, Massimo Paolucci, Roger Schank, Daniel Schwartz, Rand Spiro, Gary D. Stelling, Mia Stern, Dan Suthers, Eva Erdosne Toth, Joe Toth, Stuart G. Towns, Arlene Weiner, Beverly Park Woolf, Luke S. Zettlemoyer.</p>
