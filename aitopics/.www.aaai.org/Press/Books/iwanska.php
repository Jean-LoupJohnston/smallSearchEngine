...
<title>Natural Language Processing and Knowledge Representation: Language for Knowledge and Knowledge for Language</title>
...
<div id="logo">
<h1>Natural Language Processing and Knowledge Representation: Language for Knowledge and Knowledge for Language</h1>
</div>
<!-- begin search -->
<div id="search">
...
Natural Language Processing and Knowledge Representation: Language for Knowledge and Knowledge for Language</span></h2>
<div class="content">
<p><img height="107" width="72" src="http://www.aaai.org/Press/Books/Covers/iwanska.jpg" alt="Book Cover Image" style="float: left; margin-right: 5px;" /><b>Edited by Lucja M. Iwanska and Stuart C. Shapiro</b><br />
470 pp., references, index, illus., $48.00 softcover, ISBN 978-0-262-59021-1<br />
<a href="http://www.aaai.org/cgi-bin/sc/order.cgi?storeid=*1eb18495ca0023947820c407d8ca61f695&dbname=products&itemnum=230&function=add">[Add to Cart]</a>&nbsp;<a href="http://www.aaai.org/cgi-bin/sc/order.cgi?storeid=*1eb18495ca0023947820c407d8ca61f695&function=show">[View Cart]</a>
</p>

<p>Natural language refers to human language&mdash;complex, irregular, diverse, with all its philosophical problems of meaning and context. Setting a new direction in AI research, this book explores the development of knowledge representation and reasoning systems that take seriously the role of natural language in human information and knowledge processing.</p>
<p>Traditionally, knowledge representation and reasoning systems have incorporated natural language as interfaces to expert systems or knowledge bases that performed tasks separate from natural language processing. As this book shows, however, the computational nature of representation and inference in natural language makes it the ideal model for all tasks in an intelligent computer system. Natural language processing combines the qualitative characteristics of human knowledge processing with a computer's quantitative advantages, allowing for an in-depth, systematic processing of vast amounts of information. The essays in this interdisciplinary book cover a range of implementations and designs, from formal computational models to large-scale natural language processing systems.</p>
