...
<div id="content" class="backgrnd4"><div id="right"><div id="box6"><h2 class="backgrnd12"><span class="text1">AI Science Policy</span></h2><div class="content"><p>AAAI maintains an active role in ongoing discussions ofUS science and technology policy, principally as it relates tocomputing research in general, and to artificial intelligence inparticular. Toward the first of these ends, AAAI joins with othercomputing societies, academic departments, and research laboratoriesas a member of the Computing ResearchAssociation. Toward the second, AAAI has prepared reports, listedbelow, on AI research for US governmental agencies.</p><div class="hr1"><hr /></div><h3>A Report to ARPA on Twenty-First Century Intelligent Systems</h3><p>This report stems from an April 1994 meeting, organized by AAAI at the suggestionof Steve Cross and Gio Wiederhold. The purpose of the meeting was to assist ARPAin defining an agenda for foundational AI research. Prior to the meeting, thefellows and officers of AAAI, as well as the report committee members, were askedto recommend areas in which major research thrusts could yield significantscientific gain--with high potential impact on DOD applications--over the next tenyears. At the meeting, these suggestions and their relevance to current nationalneeds and challenges in computing were discussed and debated. </p><ul><li><a href="http://www.aaai.org/Library/Reports/arpa-report.php">View Paper</a></li></ul><hr /><h3>The Role of Intelligent Systems in the National Information Infrastructure</h3><p>The field of artificial intelligence (AI) can play a pivotal role in meeting major challenges of the NII. AI uses the theoretical and experimental tools of computer science to study the phenomena of intelligent behavior. The field not only addresses a profound scientific problem, but also develops practical technology for constructing intelligent systems. AI research has produced an extensive body of principles, representations, and algorithms. Successful AI applications range from custom-built expert systems to mass-produced software and consumer electronics. AI techniques can play a central role in the development of a useful and usable National Information Infrastructure (NII) because they offer the best alternative for addressing three key challenges.</p><p>Additional information on this subject can be found at the Computing Research Association&rsquo;sweb page: <a href="http://www.cra.org/">http://www.cra.org/</a>.</p><ul><li><a href="http://www.aaai.org/Library/Reports/nii.php">View Paper</a></li></ul></div></div></div><div id="left">
<div id="box4">
