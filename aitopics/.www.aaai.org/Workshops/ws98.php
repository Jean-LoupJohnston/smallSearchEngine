...
<title>AAAI Sponsored Workshops&mdash;AAAI-98</title>
...
<div id="logo">
<h1>AAAI Sponsored Workshops&mdash;AAAI-98</h1>
</div>
<!-- begin search -->
<div id="search">
...
<div id="right">
<div id="box6">
<h2 class="backgrnd12"><span class="text1">Workshops at the Fifteenth National Conference on Artificial Intelligence</span></h2>
<div class="content">


<p><i>Sponsored by the Association for the Advancement of Artificial Intelligence</i></p>
<hr />
<p>AAAI-1998 Workshops were held Sunday and Monday and Friday, July 26&ndash;27, 31, at the Monona Terrace Convention Center  and surrounding hotels in Madison,  isconsin. The workshops that were held are listed below:</p>
<ul>
<li>AI and  Information Integration (1-1/2 day workshop) (W1)<br />
<i>Organizers:</i> Craig  Knoblock and Alon Levy,  (Sunday PM and Monday, July 26-27) </li>

<li>Case-Based  Reasoning Integrations (W2)<br />
<i>Organizers:</i> David Aha and 
 Jody Daniels,  (Monday, July 27) </li>

<li>Functional  Modeling and Teleological Reasoning (W3)<br />
<i>Organizer:</i> Jon Sticklen, (Monday, July 27)  </li>

<li>The Grounding  of Word Meaning: Data and Models (W4)<br />
<i>Organizer:</i> Michael Gasser,   (Friday, July 31) </li>

<li>Integrating  Artificial Intelligence and Assistive Technology (W5)<br />
<i>Organizer:</i> Rich  Simpson,  (Sunday, July 26) </li>

<li>Knowledge  Sharing across Biological and  Medical Knowledge Based Systems (W6)<br />
<i>Organizers:</i>Gary  Merrill and  Dhiraj Pathak, (Sunday, July 26) </li>

<li>Learning  for Text Categorization (W7)<br />
<i>Organizer:</i>  Mehran Sahami,(Monday, July 27) </li>

<li>The Methodology  of Applying Machine Learning: Problem Definition, Task Decomposition 
 and Technique Selection (W8)<br />
 <i>Organizer:</i>  Robert Engels, (Monday, July 27) </li>

<li>Predicting the Future: AI Approaches to  Time-Series Analysis (W9)<br />
<i>Organizer:</i> Andrea  Danyluk, (Monday, July 27) </li>

<li>Recommender  Systems (W10) <br />
<i>Organizer:</i> Henry  Kautz, (Sunday, July 26) </li>

<li>Representations  for Multi-Modal Human-Computer Interaction (2-day workshop) (W11)<br />
<i>Organizers:</i> Syed  Ali and Susan McRoy  (Sunday and Monday, July 26-27) </li>

<li>Software  Tools for Developing Agents (W12)<br />
<i>Organizers:</i>Brian  Logan and  Jeremy Baxter, (Sunday, July 26) </li>

<li>Textual  Case-Based Reasoning (W13)<br />
<i>Organizers:</i>Mario  Lenz and  Kevin Ashley,  (Sunday, July 26) </li>

<li>Using AI for Knowledge Management and  Business Process Reengineering (W14)<br />
<i>Organizer:</i> Rose  Gamble, (Sunday, July 26) </li>

<li>Verification  &amp; Validation of Knowledge-Based Systems (W15)<br />
<i>Organizers:</i>Daniel  O'Leary and Alun Preece, ( Monday, July 27)</li>

</ul>
<hr /><p>For further
information about the 1998 Workshop Program, consult the following:</p>
<ul><li><a href="http://www.aaai.org/Workshops/1998/ws98proposals.pdf">Call for Proposals (1998)</a></li>
<li><a href="http://www.aaai.org/Workshops/1998/ws98participation.pdf">Call for Participation (1998)</a></li>
</ul>
<hr />
