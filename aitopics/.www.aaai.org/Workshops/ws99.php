...
<title>AAAI Sponsored Workshops&mdash;AAAI-99</title>
...
<div id="logo">
<h1>AAAI Sponsored Workshops&mdash;AAAI-99</h1>
</div>
<!-- begin search -->
<div id="search">
...
<div id="right">
<div id="box6">
<h2 class="backgrnd12"><span class="text1">Workshops at the Sixteenth National Conference on Artificial Intelligence</span></h2>
<div class="content">


<p><i>Sponsored by the Association for the Advancement of Artificial Intelligence</i></p>
<hr />
<p>AAAI-1999 Workshops were held Sunday and Monday, July 18&ndash;19, 1999, in
Orlando, Florida. 
The workshops that were held are listed below:</p>
<ul>
<li>Artificial Intelligence for Electronic Commerce (W1)<br />
<i>Organizers:</i> Tim Finin and Benjamin Grosof,  (Sunday, July 18)</li>

<li>Agent-Based Systems in the Business Context (W2)<br />
<i>Organizer:</i> Brian Drabble,  (Monday, July 19)</li>

<li>Artificial Intelligence for Distributed Information Networking (W3)<br />
<i>Organizers:</i> Sue Abu-Hakima and Steven Willmott,  (Sunday, July 18)</li>

<li>Computation with Neural Systems (W4)<br />
<i>Organizers:</i> Jim Austin, (Monday, July 19)</li>

<li>Configuration (W5)<br />
<i>Organizers:</i> Boi Faltings, Eugence C. Freuder,  and Gerhard Friedrich, (Monday, July 19)</li>

<li>Data Mining with Evolutionary Algorithms: Research Directions (W6)<br />
<i>Organizer:</i> Alex Freitas,  (Sunday, July 18 (1/2-day workshop))</li>

<li>Environmental Decision Support Systems and Artificial Intelligence (W7)<br />
<i>Organizers:</i> Miquel Sanchez-Marre and Ulises Cortes,  (Sunday, July 18)</li>

<li>Going Further with Agents Conflicts: Definitions and Roles in Agents Evolution (W8)<br />
<i>Organizers:</i> Catherine Tessier and Laurent Chaudron (Sunday, July 18)</li>

<li>Intelligent Information Systems (W9)<br />
<i>Organizers:</i> Kristian Hammond and Larry Birnbaum, (Sunday and Monday, July 18-19 (two-day workshop))</li>

<li>Intelligent Software Engineering (W10)<br />
<i>Organizers:</i> Aditya Ghose, Tim Menzies,  and Ken Satoh,  (Monday, July 19)</li>

<li>Exploring Synergies of Knowledge Management and Case-Based Reasoning (W11)<br />
<i>Organizers:</i> David Aha, Irma Becerra-Fernandez, Frank Maurer, and Hector Munoz-Avila, (Monday, July 19)</li>

<li>Machine Learning for Information Extraction (W12)<br />
<i>Organizer:</i> Mary Elaine Califf, (Monday, July 19)</li>

<li>Mixed-Initiative Intelligence (W13)<br />
<i>Organizer:</i> Michael T. Cox, (Sunday, July 18)</li>

<li>Negotiation: Settling Conflicts and Identifying Opportunities (W14)<br />
<i>Organizer:</i> Sandip Sen, (Monday, July 19)</li>

<li>Ontology Management (W15)<br />
<i>Organizers:</i> Adam Farquhar and Kilian Stoffel, (Sunday, July 18)</li>

<li>Reasoning in Context for AI Applications (W16)<br />
<i>Organizers:</i> xPatrick Brezillon and Jean-Charles Pomerol, (Monday, July 19)</li>

<li>Spatial and Temporal Reasoning for Collaborating Mobile Agents (W17)<br />
<i>Organizers:</i> Frank D. Anger and Hans W. Guesgen, (Sunday, July 18)</li>
</ul>
<hr /><p>For further
information about the 1999 Workshop Program, consult the following:</p>
<ul><li><a href="http://www.aaai.org/Workshops/1999/ws99proposals.pdf">Call for Proposals (1999)</a></li>
<li><a href="http://www.aaai.org/Workshops/1999/ws99participation.pdf">Call for Participation (1999)</a></li>
</ul>
<hr />
