...
<title>AAAI Sponsored Workshops&mdash;KDD-98</title>
...
<div id="logo">
<h1>AAAI Sponsored Workshops&mdash;KDD-98</h1>
</div>
<!-- begin search -->
<div id="search">
...
<div id="right">
<div id="box6">
<h2 class="backgrnd12"><span class="text1">Workshop at the Fourth International Conference on Knowledge Discovery <br />and Data Mining</span></h2>
<div class="content">
<p><i>Sponsored by the Association for the Advancement of Artificial Intelligence</i></p>
<hr />
<p>KDD1998 Workshops were held on Monday, August 31, 1998 in New York, New York. 
The workshops that were held are listed below:</p>
<ul>
<li>Data Mining in Finance (KW1)<br />
<i>Organizer:</i> Tae Horn Hann </li>

<li>Distributed Data Mining (KW2)<br />
<i>Organizers:</i> Hillol Kargupta and Philip Chan</li>

<li>Keys to the Commercial Success of Data Mining (KW3)<br />
<i>Organizers:</i> Kurt Thearling and Roger M. Stein</li>

</ul>
<hr />
<h3>Data Mining in Finance</h3>
<p>In recent 
years data mining is being increasingly applied in finance, especially 
to support financial asset management and risk management. It is 
considered by many financial management institutions as an innovative 
technology to support conventional quantitative techniques. Its 
use in computational finance will have a major impact in the modeling 
of currency markets, in tactical asset allocation, bond and stock 
valuation and portfolio optimization. In addition, the application 
of data mining for scoring tasks delivers valuable support for the 
management of client credit risk and fraud detection.</p> 
<p>On the other hand, 
there are interesting debates in finance that have caused controversial 
discussion over time and can significantly affect the application 
of data mining in finance. To these debates belong: 1) Efficiency 
of financial markets. According to the information efficiency of 
financial markets, price changes are unpredictable. If this is the 
case, any effort putting on <i>mining </i>historical data which 
aims to predict the future development is useless. 2) Nonlinearity 
of financial markets. If price movements in financial markets are 
linear, then the application of complicated data mining algorithms 
like neural networks is not necessary at all. Simpler methods like 
linear regression would be sufficient.</p> 
<p>The goal of this 
workshop is to provide an informal forum for researchers and practitioners 
to discuss the following topics:</p> 
<ul><li> Are there any special 
aspects of data mining in finance which are not typical for data 
mining in other fields (for examples technical fields, health, etc.)? 
</li>
<li> What are the characteristics 
of the successful applications of data mining in finance? </li>
<li>What are the typical 
pitfalls?  </li>
<li> Are the financial 
markets efficient? What are the pro and contra arguments?  </li>
<li>Are the financial 
markets nonlinear? Is there any positive or negative evidence about 
this debate?</li></ul> 
<p>This workshop 
addresses practitioners as well as researchers from those communities 
which contribute to this topic such as finance, econometrics, statistics 
and information systems.</p> 
<p>The workshop includes 
invited talks, contributed talks, two panel discussions and a final 
discussion. The invited and contributed talks discuss lessons learned 
from realized data mining projects in finance, success stories, 
pitfalls, special aspects of data mining in finance, task complexity, 
dynamic aspects and legal issues. In two panel discussions the controversial 
point of view about efficiency and non-linearity of finance markets 
are discussed by eight panelists.</p> 
<hr />
<h3>Distributed Data Mining</h3> 
<p>Automated detection of patterns 
from large amount of data is often called data mining. As computing 
and communication are increasingly converging to each other, mining 
data, stored in distributed databases with adequate attention to 
security related issues, is of growing interest. Distributed data 
mining (DDM) systems are finding an increasing number of applications 
...
<ol> 
<li>Theory and foundation 
issues in DDM: Problem decomposability and data distribution; 
complexity issues in DDM; representational issues.  </li>
<li>Methods and algorithms: 
Distributed algorithms for popular data mining techniques (e.g. 
association rules, classifiers, clustering); techniques for communication 
minimization, cooperative learning.  </li>
<li> Software agents 
and DDM: Agent based approaches in DDM. Agent interaction: cooperation, 
collaboration, negotiation, organizational behavior.  </li>
<li>DDM for spatial data: 
DDM in geographical information databases.  </li>
<li>Architectural issues 
in DDM: Architecture, control, security, communication issues. </li>
 
<li>Experimental DDM 
systems: Large experimental systems, performance, design issues. </li>
 
<li>Applications of DDM: 
Application of DDM in business, science, engineering, and medicine. </li>
 
<li>Human interaction in DDM: Human-DDM interface, multi-user interaction in DDM.  </li>
<li>Distributed data 
mining on the Internet.  </li>
<li>Parallel Data mining: 
Parallel data mining algorithms, applications; high performance 
computing in DDM </li>
</ol> 
<hr />
<h3>Keys 
to the Commercial Success of Data Mining</h3> 
<p>Successful data mining in business no longer comes down to having 
a hot algorithm and an experienced modeler. Business users care 
about things such as database support, application integration, 
business templates, flexibility, scalability, profitability, and 
other issues not historically concerning the KDD community.</p> 
<p>&#009;A number of the issues that we hope will get addressed at 
the workshop are described in Kurt Thearling's article "Some Thoughts 
on the Current State of Data Mining Software Applications" and in an interview given by Roger Stein.</p> 
<p>&#009;The goal is to bring together a diverse group of forty to 
fifty developers, users, and integrators of business data mining 
applications. The workshop will consist of in-depth case studies 
and analyses, invited speakers, and panel sessions. Time will also 
be set aside for discussions.</p> 
<p>&#009;Approximately half of the participants will come from the 
data mining development community with the other half coming from 
the data mining business user community. Business users attending 
will be selected from diverse industries such as banking, retail, 
insurance, government, internet services, telecom, etc. </p> 
<hr /><h3>Workshop Technical Reports</h3>
<p>Some KDD workshops are available as technical reports. For contents and
ordering information, consult the<a href="../Press/Reports/reports.php">
AAAI Press catalog.</a></p>
...
<div id="left">
<div id="box4">
<h2 class="backgrnd5"><span class="text1">AAAI Workshops</span></h2>
<div class="content">
