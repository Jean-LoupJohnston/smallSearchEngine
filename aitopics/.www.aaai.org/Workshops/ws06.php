...
<title>AAAI Sponsored Workshops&mdash;AAAI-06</title>
...
<div id="logo">
<h1>AAAI Sponsored Workshops&mdash;AAAI-06</h1>
</div>
<!-- begin search -->
<div id="search">
...
<div id="right">
<div id="box6">
<h2 class="backgrnd12"><span class="text1">Workshops at the Twenty-First National Conference on Artificial Intelligence</span></h2>
<div class="content">
...
<p> AAAI was pleased to present the AAAI-06 Workshop Program. Workshops were held Sunday and Monday, July 16&ndash;17, 2006 (unless otherwise noted) at the Seaport Hotel and World Trade Center in Boston, Massachusetts. The AAAI-06 workshop program included 15 workshops covering a wide range of topics in artificial intelligence. Workshops were one day unless noted otherwise in the individual description. Each workshop was limited to approximately 25 to 75 participants. Participation at these workshops was by invitation from the workshop organizers. All workshop participants were required to preregister for the AAAI-06 technical conference, and indicate which workshop(s) they would be attending. An additional workshop fee was required. Workshop working notes were distributed onsite for participants only, and may be available after the conference as technical reports. </p>
<p>The 2006 workshop program was constructed to encourage dialogue and build bridges between researchers in different subfields. Several of the workshops were follow-ons from workshops held at more specialized AI conferences.</p>

<p>The titles of the original seventeen AAAI workshops were: </p>
<ul>
<li>W1. AI-Driven Technologies for Services-Oriented Computing</li>

<li>W2. Auction Mechanisms for Robot Coordination</li>
<li>W3. Cognitive Modeling and Agent-based Simulations</li>
<li>W4. Cognitive Robotics </li>
<li>W5. Computational Aesthetics: Artificial Intelligence Approaches to Beauty and Happiness</li>
<li>W6. Educational Data Mining</li>
<li>W7. Evaluation Methods for Machine Learning</li>
<li>W8. Event Extraction and Synthesis</li>
<li>W9. Heuristic Search, Memory Based Heuristics and Their Applications</li>
<li>W10. Human Implications of Human-Robot Interaction</li>
<li>W11. Intelligent Techniques for Web Personalization</li>
<li>W12. Learning for Search</li>
<li>W13. Modeling and Retrieval Context </li>
<li>W14. Modeling Others from Observations: MOO-06</li>
<li>W15. Ontology Learning on the Semantic Web (Cancelled)</li>
<li>W16. Spatial and Temporal Reasoning (Cancelled)</li>
<li>W17. Statistical and Empirical Approaches for Spoken Dialog Systems</li>
</ul>
<hr />
<h4>More Information</h4>

<ul>
<li><a href="http://www.aaai.org/Workshops/2006/ws06call.pdf">Call for Proposals (PDF)</a></li>
<li><a href="http://www.aaai.org/Workshops/2006/ws06participation.pdf">Call for Participation (PDF)</a></li>
</ul>
<hr />
<h4>AAAI-06 Workshop Program Cochairs</h4>
<p>Joyce Chai (cochair)<br />
Department of Computer Science and Engineering<br />
Michigan State University</p>

<p>Keith Decker (cochair)<br />
