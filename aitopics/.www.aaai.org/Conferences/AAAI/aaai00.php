...
<title>AAAI-00: Seventeenth National Conference on Artificial Intelligence</title>
...
<div id="logo">
<h1>AAAI-00: Seventeenth National Conference on Artificial Intelligence</h1>
</div>
<!-- begin search -->
<div id="search">
...
<div id="content" class="backgrnd4"><div id="right"><div id="box6"><h2 class="backgrnd12"><span class="text1">The Seventeenth National Conference on Artificial Intelligence</span></h2><div class="content"><p><i>Sponsored by the Association for the Advancement of Artificial Intelligence</i></p><hr /><p>The Seventeenth National Conference on Artificial Intelligence (AAAI-00) was held July 30-August 3, 2000, at the convention center in Austin, Texas.</p> <p>"We generally overestimate what a technology can do for us in a few years and underestimate what it can do in a few decades."<br /> -John Durkin</p><p>&mdash;and artificial intelligence is no exception. From a few laboratory experiments demonstrating "general methods of intelligence," followed by several generations of creative diligence, AI has entered a new phase.</p><p>It is now commonplace to confront AI issues in virtually every software development project &mdash; database applications, hardware and software verification, computer-based games and entertainment, internet agents, information retrieval, knowledge management, and scheduling, to name a few &mdash; and frequently AI has a solution!</p><p>Meanwhile cutting edge research in AI has reached a new level of depth and sophistication through synergistic collaborations with disciplines such as neurology, psychology, linguistics, statistics, physics, and operations research. We have witnessed the creation of a true science of intelligence, and can only begin to dream of the future it will help to create.</p><p>As the premier showcase of AI science and technology, the National Conference on Artificial Intelligence will start with exciting workshops and free tutorials from leading researchers. This is an outstanding forum to learn about the state of the art in both new and established areas. The conference will then offer over 60 technical sessions on the best new research and applications across all areas of AI. In addition you have the opportunity to see:</p><ul><li>A dozen invited talks and panels by distinguished scientists on topics ranging from embodied agents to heuristic search</li><li>Robots competing for fame and glory as part of the AI Festival</li><li>And new this year, a special poster session where you can meet and talk with the authors of all presented technical papers.</li></ul><p>It's all happening in the "live music capital of the world," Austin, Texas. Austin is located on the Colorado River, at the edge of the Texas Hill Country. The Convention Center is in the heart of downtown, surrounded by restaurants and night clubs. Don't miss out!</p><p class="right"><i>Henry Kautz and Bruce Porter</i></p><hr /><p>For more information about AAAI&ndash;00, please consult the following:</p><ul><li><a href="../../Press/Proceedings/aaai00.php">Conference proceedings.</a></li><li><a href="http://www.aaai.org/Library/AAAI/aaai00contents.php">List of papers</a> (with links to abstracts) presented at the conference.</li><li><a href="http://www.aaai.org/Conferences/AAAI/2000/aaai00committee.pdf">Conference organizers and program committee.</a> (PDF).</li><li><a href="http://www.aaai.org/Conferences/AAAI/2000/aaai00program.pdf">Conference program</a> (PDF).</li><li><a href="http://www.aaai.org/Conferences/AAAI/2000/aaai00brochure.pdf">Conference brochure</a> (PDF).</li><li><a href="http://www.aaai.org/Conferences/AAAI/2000/aaai00call.pdf">Call for papers</a> (PDF).</li><li><a href="http://www.aaai.org/Conferences/AAAI/2000/aaai00tutorialcall.pdf">Call for tutorials</a> (PDF).</li><li><a href="http://www.aaai.org/Conferences/AAAI/2000/aaai00sigartcall.pdf">Doctoral consortium call for papers</a> (PDF).</li><li><a href="http://www.aaai.org/Conferences/AAAI/2000/aaai00exhibitcontract.pdf">Exhibit contract</a> (PDF).</li><li><a href="http://www.aaai.org/Conferences/AAAI/2000/aaai00isdemoscall.pdf">Intelligent systems demos call for participation</a> (PDF).</li> <li><a href="http://www.aaai.org/Conferences/AAAI/2000/aaai00invitedtalks.pdf">Invited talks</a> (PDF).</li><li><a href="http://www.aaai.org/Conferences/AAAI/2000/aaai00program.pdf">Outstanding paper awards</a> (PDF).</li><li><a href="http://www.aaai.org/Conferences/AAAI/2000/aaai00robotcall.pdf">Robot program call for participation</a> (PDF).</li><li><a href="http://www.aaai.org/Conferences/AAAI/2000/aaai00rblcall.pdf">Robot building lab call for participation</a> (PDF).</li><li><a href="http://www.aaai.org/Conferences/AAAI/2000/aaai00studentcall.pdf">Student call for papers</a> (PDF).</li><li><a href="http://www.aaai.org/Conferences/AAAI/2000/aaai00scholarship.pdf">Student scholarship application</a> (PDF).</li><li><a href="http://www.aaai.org/Conferences/AAAI/2000/aaai00tutorialcall.pdf">Tutorials call for proposals</a> (PDF).</li><li><a href="../../Workshops/ws00.php">Workshop program</a></li></ul></div></div></div><div id="left">
<div id="box4">
