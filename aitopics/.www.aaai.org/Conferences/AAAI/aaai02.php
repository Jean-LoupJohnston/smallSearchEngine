...
<title>AAAI-02: Eighteenth National Conference on Artificial Intelligence</title>
...
<div id="logo">
<h1>AAAI-02: Eighteenth National Conference on Artificial Intelligence</h1>
</div>
<!-- begin search -->
<div id="search">
...
<div id="content" class="backgrnd4"><div id="right"><div id="box6"><h2 class="backgrnd12"><span class="text1">The Eighteenth National Conference on Artificial Intelligence</span></h2><div class="content"><p><i>Sponsored by the Association for the Advancement of Artificial Intelligence</i></p><hr /><p>The Eighteenth National Conference on Artificial Intelligence (AAAI-02) was held July 28 &ndash; August 1, 2002, at the Shaw conference center in Edmonton, Alberta, Canada.</p> <p>As the premier showcase of AI science and technology, the national conference will start with workshops and free tutorials from leading researchers. This is an outstanding forum to learn about the state of the art in both new and established areas. The conference will then offer 121 technical papers on the best new research and applications across all areas of AI. This year, for the first time, we will have all the papers presented in two specialized poster sessions, graciously treated with food and drinks. You will have the opportunity to meet and talk with the authors of all technical papers. In addition, there will be a single plenary session, presenting a selected set of papers from diverse areas, highlighting the main directions in those areas, and geared towards unifying and sharing information across the AI spectrum. You will also have the opportunity to listen to five invited talks ranging from traditional to unconventional AI.</p><p>	It is all happening in beautiful Edmonton, a great place for visitors to explore the North Saskatchewan River, which winds through the heart of the city. The long summer days are great for riverside walks, golf, cycling tours and exploring around town. The world famous Banff and Jasper National glacier Parks, which offer outstanding hiking and sightseeing in the summer, are only four hours away. Edmonton is well known as an active arts and drama city. Visitors can participate in a variety of festivals such as Klondike Days (July 18-27), the Heritage Days Festival (Aug. 3-5), the Edmonton Folk Festival (Aug. 8-11) and the Fringe Festival (Aug. 15-25). Edmonton has more than 2000 restaurants and many shopping centers, including North America's largest indoor shopping mall.</p><p>Don't miss it!</p><p class="right"><i>Rina Dechter, Michael Kearns, and Rich Sutton</i></p><hr /><p>For more information about AAAI&ndash;02, please consult the following:</p><ul><li><a href="../../Press/Proceedings/aaai02.php">Conference proceedings.</a></li><li><a href="http://www.aaai.org/Library/AAAI/aaai02contents.php">List of papers</a> (with links to abstracts) presented at the conference.</li><li><a href="http://www.aaai.org/Conferences/AAAI/2002/aaai02committee.pdf">Conference organizers and program committee.</a></li><li><a href="http://www.aaai.org/Conferences/AAAI/2002/aaai02bestpaper.pdf">Outstanding paper award</a> (PDF).</li><li><a href="http://www.aaai.org/Conferences/AAAI/2002/aaai02brochure.pdf">Conference brochure</a> (PDF).</li><li><a href="http://www.aaai.org/Conferences/AAAI/2002/aaai02program.pdf">Conference program</a> (PDF).</li><li><a href="http://www.aaai.org/Conferences/AAAI/2002/aaai02call.pdf">Call for papers </a> (PDF).</li><li><a href="http://www.aaai.org/Conferences/AAAI/2002/aaai02sigartcall.pdf">Doctoral consortium call for participation</a> (PDF).</li><li><a href="http://www.aaai.org/Conferences/AAAI/2002/aaai02invitedtalks.pdf">Invited talks</a> (PDF).</li><li><a href="http://www.aaai.org/Conferences/AAAI/2002/aaai02isdemoscall.pdf">Intelligent systems demos call for participation</a> PDF.</li><li><a href="http://www.aaai.org/Conferences/AAAI/2002/aaai02rblcall.pdf">Robot building laboratory call for participation</a> PDF.</li> <li><a href="http://www.aaai.org/Conferences/AAAI/2002/aaai02robotcall.pdf">Robot program call for participation</a> PDF.</li> <li><a href="http://www.aaai.org/Conferences/AAAI/2002/aaai02scholarship.pdf">Scholarship application</a> (PDF).</li><li><a href="http://www.aaai.org/Conferences/AAAI/2002/aaai02sponsorship.pdf">Sponsorship program</a> (PDF).</li><li><a href="http://www.aaai.org/Conferences/AAAI/2002/aaai02studentcall.pdf">Student call for papers</a> (PDF).</li><li><a href="http://www.aaai.org/Conferences/AAAI/2002/aaai02tutorialcall.pdf">Tutorials call for proposals</a> (PDF).</li><li><a href="http://www.aaai.org/Conferences/AAAI/2002/aaai02volunteer.pdf">Volunteer program application</a> </li><li><a href="../../Workshops/ws02.php">Workshop program.</a></li><li><a href="http://www.aaai.org/Members/Photographs/2002/photos.php">Photographs</a> taken at the AAAI-02 Conference (restricted to AAAI members only)</li></ul></div></div></div><div id="left">
<div id="box4">
