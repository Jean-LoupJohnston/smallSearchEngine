...
<title>AAAI-07: Special Track on Integrated Intelligence</title>
...
<div id="logo">
<h1>AAAI-07: Special Track on Integrated Intelligence</h1>
</div>
<!-- begin search -->
<div id="search">
...
<div id="content" class="backgrnd4">
	<div id="right">
		<div id="box6">
			<h2 class="backgrnd12"><span class="text1">AAAI-07 Special Track on Integrated Intelligence</span></h2>
<p>The Special Track on Integrated Intelligence (II)</a> emphasizes research on evaluated approaches and techniques that synergistically combine abilities from distinct areas of AI to achieve intelligent behavior.</p>
<p>To solve complex, real-world problems, AI systems often must integrate component technologies, such as planning, reasoning, language, dialogue, perception, goal-driven action, and learning. Prototypical examples of such integrated systems include software agents, autonomous robots, intelligent tutoring systems, and virtual characters. The Integrated Intelligence track includes papers on issues that arise in the design and construction of such systems.</p>
...
</ul>			<h3 class="text2">Special Track Cochairs</h3>
<p><i>Reid Simmons (Carnegie Mellon University), Cochair<br />
Pat Langley (Arizona State University), Cochair</i></p>
<p>The original AAAI-07 Integrated Intelligence call for papers is available as a printable <a href="http://www.aaai.org/Conferences/AAAI/2007/aaai07iiccall.pdf">PDF document</a></p>
		</div>
	</div>
	<div id="left">
	<div id="box4">
