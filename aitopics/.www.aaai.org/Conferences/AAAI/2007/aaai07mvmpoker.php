...
<title>AAAI Man vs. Machine Poker Challenge</title>
...
<div id="logo">
<h1>AAAI Man vs. Machine Poker Challenge</h1>
</div>
<!-- begin search -->
<div id="search">
...
<div id="content" class="backgrnd4">
	<div id="right">
		<div id="box6">
			<h2 class="backgrnd12"><span class="text1">AAAI Man vs. Machine Poker Challenge</span></h2>
<p>The Man Versus Machine Poker Challenge will be held Monday, July 23, 12:00 PM &ndash;7:00 PM in Regency B, and Tuesday, July 24, 9:00 AM &ndash;5:00 PM, in Plaza B</p>

<p>AAAI will play host to the first scientific man versus machine challenge in poker. Poker is a game of skill and luck. A &ldquo;short&rdquo; match, even one of 10,000 hands, may not be enough to identify the better player. At AAAI, two professional poker players (Phil Laak and Ali Esmali) will play a duplicate match against two copies of the University of Alberta Polaris poker program. There will be four sessions played, each with $5,000 at stake. In a session, each human plays 500 hands against a copy of Polaris. However, the cards dealt in the first match to the human will be dealt to the computer in the second match, and vice versa. The result of session is the sum of the two humans&rsquo; scores versus the sum of the two programs&rsquo; scores. This format, inspired by the rules of duplicate bridge, significantly reduces the luck element, increasing the chances that the best team will win based on skill.</p>

<p>The matches will be played in front of an audience, and the human competitors will be encouraged to think out loud. The result will be entertaining, and give insights as to the state of the art in AI technology for a challenging imperfect information domain.</p>


<h3 class="text2">Chair</h3>
<p><i>Jonathan Schaeffer (University of Alberta)</i></p>
		</div>
	</div>
	<div id="left">
	<div id="box4">
