...
<title>Second Annual AAAI Computer Poker Competition</title>
...
<div id="logo">
<h1>Second Annual AAAI Computer Poker Competition</h1>
</div>
<!-- begin search -->
<div id="search">
...
<div id="content" class="backgrnd4">
	<div id="right">
		<div id="box6">
			<h2 class="backgrnd12"><span class="text1">Second Annual AAAI Computer Poker Competition</span></h2>
<p>The Second Annual AAAI Computer Poker Competition will be held Tuesday &ndash;Thursday, July 24&ndash;26 in Plaza B.</p>
<p>In this competition, 28 teams from 10 countries will develop computer programs for playing heads-up limit and no-limit Texas Hold'em. Programs will be judged based upon their robustness (ability to beat any opponent head-to-head) and/or their ability to learn (to exploit weaker opponents for more money). The University of Alberta is providing 34 months of computer time to allow each program to play millions of hands. At AAAI, the results, highlighted hands, and posters describing the bots will be presented. Visitors will have an opportunity to play against some of the submitted poker programs.</p>
<p>Details (inclouding rules) of the poker competition are available at the <a href="http://www.cs.ualberta.ca/~pokert/2007/rules.php">University of Alberta.</a></p>
<h3 class="text2">Special Track Chair</h3>
<p><i>Martin Zinkevich (University of Alberta)</i></p>
		</div>
	</div>
	<div id="left">
	<div id="box4">
