...
<title>AAAI-14 Program Overview</title>
...
<div id="logo">
<h1>AAAI-14 Program Overview</h1>
</div>
<!-- begin search -->
<div id="search">
...
<div id="right">
<div id="box6">
<h2 class="backgrnd12"><span class="text1">AAAI-14 Program Overview</span></h2>

<h3 class="text2">AAAI-14 Program Overview</h3>
...
<ul>
	...
	<li>Workshops</li>
	<li>AAAI/SIGART Doctoral Consortium</li>
	<li>Symposium on Educational Advances in Artificial Intelligence (EAAI-14)</li>
	<li>AAAI-14 Opening Reception (Evening)</li>
	<li>AAAI-14/IAAI-14 Joint Invited Talk: Adam Cheyer (Evening)</li>
</ul>
...
<ul>
	<li>AAAI-14 Opening Ceremony and Awards (8:30am)</li>
	<li>AAAI-14/IAAI-14/EAAI-14 Invited Talks<br />
	9:00 AM: Craig Knoblock<br />
  	1:00 PM: Michael Kearns<br />
  	4:00 PM: Cynthia Breazeal</li>
	<li>AAAI-14/IAAI-14/EAAI-14 Technical Program</li>
	<li>Competitions/Exhibits</li>
	<li>AAAI-14 Poster Reception (Evening)</li>
	<li>AAAI-14 Fete &ndash; Le Th&eacute;&acirc;tre &amp; Le Cabaret du Capitole de Qu&eacute;bec</li>
	

</ul>

<p>
<b>Wednesday, July 30</b>
</p>

<ul>
	<li>AAAI-14/IAAI-14 Invited Talks<br />
	9:00 AM: Ron Kaplan</li>
	<li>AAAI-14/IAAI-14 Technical Program</li>
	<li>2014 AAAI Presidential Address: Manuela Veloso</li>
	<li>Competitions/Exhibits</li>
	<li>Speed Dating</li>
	<li>Pasta Buffet (Evening)</li>
	<li>Fun &amp; Games Night (Evening)</li>
</ul>

<p>
<b>Thursday, July 31</b>
</p>

<ul>
	<li>AAAI-14/IAAI-14 Invited Talks<br />
	 10:15 AM: Milind Tambe<br />
  1:30 PM: Padhraic Smyth</li>
	<li>AAAI-14/IAAI-14 Technical Program</li>
	<li>Competitions/Exhibits</li>
