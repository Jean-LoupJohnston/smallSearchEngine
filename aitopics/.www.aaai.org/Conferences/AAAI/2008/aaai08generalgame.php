...
<title>AAAI-08: General Game Playing Competition</title>
...
<div id="logo">
<h1>AAAI-08: General Game Playing Competition</h1>
</div>
<!-- begin search -->
<div id="search">
...
<div id="right">
<div id="box6">
<h2 class="backgrnd12"><span class="text1">General Game Playing Competition</span></h2>

<p>General game players are computer systems that are able to accept declarative descriptions of arbitrary games at runtime and are able to play those games effectively without human intervention. Because general game players accept game descriptions at runtime, as opposed to specialized game players such as Deep Blue, they cannot rely on algorithms designed in advance for specific games. Instead, general game players are characterized by their use of general cognitive information-processing technologies such as knowledge representation, reasoning, learning, and rational decision-making, often in an integrated fashion.</p>

<p>While general game playing is a topic with inherent interest, work in its area has practical value as well. Its underlying technology can be used in a variety of other application areas, such as business process management, electronic commerce, and military operations.</p>

<h4>The Competition</h4>
</p>

<p>This year's AAAI competition is designed to test the abilities of general game players by comparing their performance on a variety of previously unseen games. The 2008 competition will consist of three rounds of competition held during May and June 2008, with a final championship round to be held in Chicago at the AAAI. Scores accumulated over the course of those three rounds will be used to determine player rankings and the top 8 scoring players will be invited to compete at AAAI where the winner will be crowned champion.</p>

<p>Entrants will compete on a wide variety of games organized into taxonomies designed to isolate features of general games that are both exploitable and scientifically interesting. Examples of such taxonomies include number of players, branching factor, repeated states, and decomposability into independent sub-games. Entrants will be expected to play games that require both competition and cooperation, as well as games that may not be exhaustively searchable in the time allowed.</p>

<h4>Prize and Eligibility</h4>

<p>The team that programs this year's champion will be awarded a $10,000 prize. AAAI gratefully acknowledges the generous contribution of Michael Genesereth (Stanford University), which makes this award possible. The competition is open to the public with the exception of affiliates of Stanford University. Additionally, each team that is invited to the finals is asked to appear in person with a poster describing their player.</p>

<p>To encourage participation, an entry fee will not be charged. Onsite competition participants will be admitted to the competition and exhibit areas, but not to the technical or social events of the main conference. Finalists are encouraged to register for the AAAI-08 conference to attend research presentations and events relevant to the topics of the competition.</p>
...
<p>For more information, please see <a href="http://games.stanford.edu">games.stanford.edu</a> where information specific to this year's competition will appear in its final form no later than January 15, 2008.</p>


<p>The AAAI-08 General Game Playing Competition call for participation is also available as a printable <a href="http://www.aaai.org/Conferences/AAAI/2008/aaai08generalgame.pdf">PDF document</a></p>
</div>
</div>
<div id="left">
<div id="box4">
