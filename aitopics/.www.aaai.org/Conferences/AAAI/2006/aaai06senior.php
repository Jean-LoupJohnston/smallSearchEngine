...
<title>AAAI-06 Senior Member Papers</title>
...
<div id="content" class="backgrnd4">	<div id="right">		<div id="box6">			<h2 class="backgrnd12"><span class="text1">AAAI Senior Member Papers</span></h2><p>New this year, the Senior Member Presentation Track provides the opportunity for established researchers to give a broad talk on a well-developed body of research, an important new research area, or a thoughtful critique of trends in the field. These presentations will provide a "big picture" view in contrast to regular papers, which may focus on a specific contribution.</p><p>Submissions were only considered from researchers who are at least 10 years out from their PhD, with a track record of publishing on their topic, and researchers presenting in the Senior Member Track cannot be first author on any other submission.</p><p>The list of papers to be presented at AAAI-06 is can be found in the <a href="http://www.aaai.org/Library/AAAI/aaai06contents.php#senior">AAAI-06 proceedings.</a></p><p>A complete description of the Senior Member track can be found in the <a href="aaai06call-booklet.pdf">AAAI06 Call.</a></p></div></div><div id="left"><div id="left">
<div id="box4">
