...
<title>AAAI-06 Member Abstracts and Posters</title>
...
<div id="content" class="backgrnd4">	<div id="right">		<div id="box6">			<h2 class="backgrnd12"><span class="text1">AAAI Member Abstracts and Posters</span></h2><p>The goal of this novel program is to provide a forum in which AAAI members can present and discuss their work based on a submitted abstract, rather than a regular AAAI paper. In order to stimulate cross-fertilization and the free circulation of ideas, AAAI encouraged its members to submit posters of various types: (1) original, unpublished work, (2) summary of a recently published paper, or (3) overview/synthesis of the author's work in a particular field or application of AI.</p><p>Each member was permitted to submit at most one abstract, and only if they were not authors of any accepted submissions to any calls for the conference. Abstracts were accepted or rejected for this program solely based on merit, regardless of the outcomes of related paper submissions.</p><p>Member abstracts will be made available via the AAAI Web site (because of the late submission date, the abstracts cannot be included in the AAAI proceedings). All AAAI members will be able to access member posters. Authors of accepted member abstract submissions must register for the conference in order for their submission to be included in the Web site.</p><p>Accepted abstracts will be allocated presentation time and space in the member poster display area at the conference. Member authors of accepted abstracts must agree to prepare a poster representing the work described in their abstracts and to be available to discuss their work with visitors during their allocated time in the member poster display area.</p><p><b>Cochairs:</b><br />Dieter Fox, <i>University of Washington</i> <br />Ion Muslea, <i>Language Weaver</i></p><hr /><p>The list of papers to be presented at AAAI-06 can be found in the <a href="http://www.aaai.org/Library/AAAI/aaai06contents.php#members">AAAI-06 proceedings.</a></p></div></div><div id="left"><div id="left">
<div id="box4">
