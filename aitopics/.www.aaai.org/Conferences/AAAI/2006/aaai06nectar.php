...
<title>AAAI-06 Nectar Papers</title>
...
<div id="content" class="backgrnd4">	<div id="right">		<div id="box6">			<h2 class="backgrnd12"><span class="text1">AAAI Nectar Papers</span></h2><p>As AI matures and becomes increasingly interdisciplinary, many of the AI community's most exciting results appear in the proceedings of AAAI's sister conferences and conferences in related fields. AAAI-06 includes a new special paper track designed to highlight those results in a way that is accessible to the broad AI audience.</p><p>This new track, AAAI Nectar (New sCientific and Technical Advances in Research), consists of papers that are based on a result that has already appeared in the proceedings of at least one major, AI-related conference in 2004, 2005 or 2006. Examples of such conferences include: A-LIFE, AAMAS, ACL, CogSci, ICAPS, ICML, ISWC, IUI, KCAP, KR, NIPS, ICRA, and UAI. Examples of conferences in related fields with relevance to AIare KDD, SIGIR, SIGMOD, VLDB, and WWW.</p><p>One important goal of the track is to offer young researchers the opportunity to learn about areas with which they may not already be familiar. Another goal is to encourage the sort of cross-disciplinary AI work that has historically been supported by AAAI.</p><p>Nectar papers are up to four pages in length, and focus on a major result that has already been described by the author in one or more papers in the above conferences during the period 2004&ndash;2006. Nectar papers cite the previous publications, summarize the core result, and put the result, as well as the problem it solves, into a context that is meaningful to a wide AI audience.</p><p>The AAAI Nectar track includes both invited and submitted papers. They will be presented as short talks or as posters in a special section at AAAI-06. </p><p>The list of papers to be presented at AAAI-06 can be found in the <a href="http://www.aaai.org/Library/AAAI/aaai06contents.php#nectar">AAAI-06 proceedings.</a></p><p>A complete description of the Nectar Papers track can be found in the <a href="aaai06call-booklet.pdf">AAAI06 Call.</a></p></div></div><div id="left"><div id="left">
<div id="box4">
