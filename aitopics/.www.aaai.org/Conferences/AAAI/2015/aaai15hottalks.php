...
<title>AAAI-15: Whats Hot Talks</title>
...
<ul>
	<li>What's Hot in the Angry Birds Artificial Intelligence Competition<br />
	Jochen Renz</li>

	<li>What's Hot in the Automated Negotiating Agents Competition<br />
	Koen Hindriks</li>

	<li>What's Hot in Computer Vision and Pattern Recognition (CVPR)<br />
	Rene Vidal</li>

	<li>What's Hot in Crowdsourcing and Human Computation (HCOMP)<br />
	Jeffrey Bigham</li>

	<li>What's Hot in the General Game Playing Competition<br />
	Michael Genesereth</li>

	<li>What's Hot in Human Factors in Computing Systems (CHI)<br />
	Wei Li</li>

	<li>What's Hot in Intelligent Robots and Systems (IROS)<br />
	Lynne Parker</li>

	<li>What's Hot in Knowledge Discovery and Data Mining (KDD)<br />
	Wei Wang</li>

	<li>What's Hot in Knowledge Representation and Reasoning (KR)<br />
	Chitta Baral</li>

	<li>What's Hot in the Planning Competition<br />
	Stefan Edelkamp</li>

	<li>What's Hot in the RoboCup@Home Competition<br />
	Sven Wachsmuth</li>

	<li>What's Hot in the SAT and ASP Competitions<br />
	Marijn Heule, Torsten Schaub</li>
