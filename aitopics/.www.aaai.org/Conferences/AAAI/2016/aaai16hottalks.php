...
<title>AAAI-16: Whats Hot Talks</title>
...
<div id="content" class="backgrnd4">
	<div id="right">
		<div id="box6">
			<h2 class="backgrnd12"><span class="text1">AAAI-16 What's Hot Talks</span></h2>

<p>The AAAI-16 â¬SWhatâ¬"s Hotâ¬ý track aims to present exciting recent advances and current challenges in subareas of Artificial Intelligence with major conferences or competitions. Fifteen â¬SWhatâ¬"s Hotâ¬ý presentations will be presented, representing the AAMAS, ILP, ICCV, ICRA, IUI, NAACL, UAI, and SoCS conferences, as well as the Angry Birds, ASP, General Video Game AI, Kaggle, Planning, RoboCup, and Winograd Schema Challenge competitions. All What's Hot talks will be held in WEST 106B, 1st Level, Phoenix Convention Center. For presentations times, please see the <a href="http://www.aaai.org/Conferences/AAAI/2016/aaai16schedule.pdf">schedule.</a>)</p>



<ul>
	<li>Whatâ¬"s Hot in Human Language Technology: Highlights from NAACL HLT 2015<br />
	Joyce Y. Chai, Anoop Sarkar, Rada Mihalcea</li>

	<li>UAI 2015<br />
	Marina Meila</li>

	<li>Whatâ¬"s Hot in Intelligent User Interfaces<br />
	Shimei Pan, Oliver Brdiczka, Giuseppe Carenini, Duen Horng Chau, Per Ola Kristensson</li>

	<li>Inductive Logic Programming: Challenges<br />
	Katsumi Inoue, Hayato Ohwada, Akihiro Yamamoto</li>

	<li>Kaggle Competition / Winograd Schema Challenge Competition (9 minutes each)<br />
	Oren Etzioni (Kaggle) and Leora Morgenstern or Charles Ortiz (Winograd)</li>
	<li>ICCV 2015<br />
	Greg Hager</li>
	...
	<li>Angry Birds as a Challenge for Artificial Intelligence<br />
	Jochen Renz, XiaoYu Ge Rohan Verma, Peng Zhang</li>

	<li>Whatâ¬"s Hot at RoboCup<br />
	Peter Stone</li>

	<li>General Video Game AI: Competition, Challenges, and Opportunities<br />
	Diego Perez Liebana, Spyridon Samothrakis, Julian Togelius, Simon M. Lucas, Tom Schaul</li>

	<li>AAMAS 2015<br />
	Maria Gini</li>

	<li>Competition of Distributed and Multiagent Planners (CoDMAP)<br />
	Michal Stolba, AntonÃ­n Komenda, Daniel L. Kovacs</li>

	<li>Whatâ¬"s Hot in the Answer Set Programming Competition<br />
	Martin Gebser, Marco Maratea, Francesco Ricca<br />
	<li>Talk by Mario Alviano</li>

	<li>Whatâ¬"s Hot in Heuristic Search? (SoCS 2015)<br />
	Roni Stern, Levi H. S. Lelis</li></ul>
