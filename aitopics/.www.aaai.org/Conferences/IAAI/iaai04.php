...
<title>IAAI-04: The Sixteenth Conference on Innovative Applications of Artificial Intelligence</title>
...
<div id="logo">
<h1>The Sixteenth Conference on Innovative Applications of Artificial Intelligence</h1>
</div>
<!-- begin search -->
<div id="search">
...
<div id="content" class="backgrnd4"><div id="right"><div id="box6"><h2 class="backgrnd12"><span class="text1">The Sixteenth Conference on Innovative Applications of Artificial Intelligence</span></h2><div class="content"><p><i>Sponsored by the Association for the Advancement of Artificial Intelligence</i></p><hr /><p>The Sixteenth Innovative Applications of Artificial Intelligence Conference on Artificial Intelligence (IAAI-04) was collocated with <a href="../AAAI/aaai04.php">AAAI-04</a>, and held July 27&ndash;29, 2004 at the convention center in San Jose, California.</p><p>The Sixteenth Annual Conference on Innovative Applications ofArtificial Intelligence (IAAI-04) continued the IAAI tradition ofincluding both case studies of deployed applications and papers onemerging AI applications. The deployed applications papers all includedconcrete measurements of the benefits provided by AI technology.IAAI-04 was organized as an independent program within the AAAInational conference, with schedules coordinated to allow attendeesto move freely between AAAI and IAAI sessions. We appreciatedthe cooperation of the AAAI organizers, since we believe the collocatedconferences both benefited from each other.AI applications developers benefited from learning about the latestAI techniques that will enable the next generation of applications.Basic AI research benefited by exposure to the challenges of real-worlddomains and difficulties and successes in applying AI techniquesto real business problems. IAAI-04 addressed the full rangeof AI techniques including knowledge-based systems, planningand scheduling, perception and monitoring, knowledge formation,knowledge management, learning, intelligent design, natural languageprocessing, and diagnostic reasoning.</p><p>Deployed applications are case studies that provide a valuableguide to designing, building, managing, and deploying systems incorporatingAI technologies. The 2004 papers addressed applicationsin a wide variety of domains, including natural languageprocessing, secure mobile agents, sales support, securities fraud detection,and scheduling. These applications provided clear evidenceof the impact and value that AI technology has in today&rsquo;s world.</p><p>Papers on emerging applications and technologies described effortswhose goal is the engineering of AI applications. They informedAI researchers about the utility of specific AI techniques for applicationsdomains and also informed applications developers abouttools and techniques that will enable the next generation of newand more powerful applications.</p><p>The invited Robert Engelmore Memorial Lecture for 2004 wasgiven by Dr. Edward Feigenbaum. Ed spoke about one of Bob Engelmore&rsquo;s favorite topics: &ldquo;The Unexploited Power ofBlackboards.&rdquo; Ed was the perfect person to deliver this lecture, becausehe knew Bob from the time they roomed together at Carnegie TechnicalInstitute (now CMU), and Ed is a passionate champion forthe power of blackboards in applying knowledge to solve challengingproblems.</p><p>For 2004, we were very pleased to have two in-depth panels. The&ldquo;AI in Robotics&rdquo; panel was moderated by Neil Jacobstein. Thepanel featured participants covering robotics at NASA,DARPA, Sony, iRobot and Hasbro. Manuela Veloso providedher vision of the state of AI in robotics, including robot soccer andother developments. The panel featured a 360-degree view coveringAI, systems engineering, marketing, business, and user adoptionaspects of the topic. Robotics has been an emerging AI areafor many years. It fuses difficult hardware and software problemsto provide new capabilities for digital interactions with the physicalworld. AI in robotics applications recently began torack up several commercial and government project successes.</p><p>The eScience panel was moderated by Yolanda Gil. eScienceis an emerging way to conduct large and small scale scientific enterprises.It leverages the power of AI in document managementand search, collaboration tools, simulation, sequencing, and otherforms of problem solving. The panel addressed the multidisciplinaryrequirements of scientific research and how the growingcyber-infrastructure will support progress in the field.</p><p class="right"><i>Randall Hill and Neil Jacobstein</i></p><hr /><p>For further information about the IAAI 2004 Conference, consult the following:</p><ul><li><a href="http://www.aaai.org/Press/Proceedings/iaai04.php">Conference proceedings</a></li><li><a href="http://www.aaai.org/Library/IAAI/iaai04contents.php">List of papers</a> (with links to abstracts) presented at the conference.</li><li><a href="http://www.aaai.org/Conferences/AAAI/2004/aaai04invitedtalks.pdf">Invited talks</a></li><li><a href="http://www.aaai.org/Conferences/IAAI/2004/iaai04-call.pdf">Conference call for papers</a> and <a href="http://www.aaai.org/Conferences/IAAI/2004/iaai04-callbooklet.pdf">calls booklet</a></li><li><a href="http://www.aaai.org/Conferences/AAAI/2004/aaai04program.pdf">Conference program</a></li><li><a href="http://www.aaai.org/Conferences/AAAI/2004/aaai04committee.pdf">Conference organizers and program committee.</a></li></ul><div class="hr1"><hr /></div></div></div></div><div id="left">
<div id="box4">
