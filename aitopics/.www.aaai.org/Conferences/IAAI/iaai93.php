...
<title>IAAI-93: The Fifth Conference on Innovative Applications of Artificial Intelligence</title>
...
<div id="logo">
<h1>The Fifth Conference on Innovative Applications of Artificial Intelligence</h1>
</div>
<!-- begin search -->
<div id="search">
...
<div id="content" class="backgrnd4"><div id="right"><div id="box6"><h2 class="backgrnd12"><span class="text1">The Fifth Conference on Innovative Applications of Artificial Intelligence</span></h2><div class="content"><p><i>Sponsored by the Association for the Advancement of Artificial Intelligence</i></p><hr /><p>The Fifth Innovative Applications of Artificial Intelligence Conference on Artificial Intelligence (IAAI-93) was collocated with <a href="../AAAI/aaai93.php">AAAI-93</a>, and held July 11&ndash;15, 1993, at the convention center in Washington, D.C.</p><p>The Innovative Applications of Artificial Intelligence conferences highlight the most successful applications of AI techniques to real-world problems. The applications selected this year continue to illustrate the maturity of AI as a commercially viable set of technologies. AI has infiltrated a huge number of companies around the world and has enabled those companies to solve significant business problems and achieve major business benefits. This year's IAAI applications represent a cross-section of large-scale organizations and tasks. Industries represented include computers, telecommunications, aerospace, automotive, paper/pulp, energy, as well as government agencies. Functions that have been AI-automated range from enterprisewide administrative workflow to software design, from automotive process planning and cost estimation to finished goods inspection. They cover product and facilities design, customer service, diagnosis, quality management, and production. As a whole, the applications show the continued movement of AI into critical core business functions. </p><p>Each application in this volume represents a case study on how to use AI effectively to solve significant business problems. As a whole, these applications provide important lessons on how to design, build, manage and deploy successful AI systems.</p><p class="right"><i> Philip Klahr and Elizabeth Byrnes</i></p><hr /><p>For further information about the IAAI 1993 Conference, consult the following:</p><ul><li><a href="http://www.aaai.org/Press/Proceedings/iaai93.php">Conference proceedings</a></li><li><a href="http://www.aaai.org/Library/IAAI/iaai93contents.php">List of papers</a> (with links to abstracts) presented at the conference.</li><li><a href="http://www.aaai.org/Conferences/IAAI/1993/iaai93-brochure.pdf">Conference brochure</a></li></ul><div class="hr1"><hr /></div></div></div></div><div id="left">
<div id="box4">
