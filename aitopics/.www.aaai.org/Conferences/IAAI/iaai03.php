...
<title>IAAI-03: The Fifteenth Conference on Innovative Applications of Artificial Intelligence</title>
...
<div id="logo">
<h1>The Fifteenth Conference on Innovative Applications of Artificial Intelligence</h1>
</div>
<!-- begin search -->
<div id="search">
...
<div id="content" class="backgrnd4"><div id="right"><div id="box6"><h2 class="backgrnd12"><span class="text1">The Fifteenth Conference on Innovative Applications of Artificial Intelligence</span></h2><div class="content"><p><i>Sponsored by the Association for the Advancement of Artificial Intelligence</i></p><hr /><p>IAAI-03 was collocated with the International Joint Conference on Artificial Intelligence, and held August 12&ndash;14, 2003 at the convention center in Acapulco, Mexico</p><p>The Fifteenth Annual Conference on Innovative Applications of Artificial Intelligence (IAAI&ndash;03) continued the IAAI tradition of including both case studies of deployed applications and papers on emerging AI applications. The deployed applications papers all included concrete measurements of the benefits provided by AI technology. IAAI&ndash;03 was organized as an independent program within the International Joint Conference on Artificial Intelligence, with schedules coordinated to allow attendees to move freely between IJCAI and IAAI sessions. We appreciated the cooperation of the IJCAI organizers, since we believe the collocated conferences both benefited from each other. AI applications developers benefited from learning about the latest AI techniques that will enable the next generation of applications. Basic AI research benefited by exposure to the challenges of real-world domains and difficulties and successes in applying AI techniques to real business problems. IAAI&ndash;03 addressed the full range of AI techniques including knowledge-based systems, planning and scheduling, perception and monitoring, knowledge formation, knowledge management, learning, intelligent design, natural language processing, and diagnostic reasoning. Deployed applications are case studies that provide a valuable guide to designing, building, managing, and deploying systems incorporating AI technologies. The 2003 papers addressed applications in a wide variety of domains, including natural language processing, secure mobile agents, sales support, securities fraud detection, and scheduling. These applications provided clear evidence of the impact and value that AI technology has in today&rsqup;s world. Papers on emerging applications and technologies described efforts whose goal was the engineering of AI applications. They informed AI researchers about the utility of specific AI techniques for applications domains and also informed applications developers about tools and techniques that will enable the next generation of new and more powerful applications. </p><p>For 2003, we were very pleased to have three invited talks. Noah Friedland discussed recent progress on a long-term project to build a &ldquo;Digital Aristotle,&rdquo; an application capable of answering a broad range of questions in a specific domain. Noah  discussed progress in answering questions from an advanced high school chemistry syllabus. Representatives of the specific projects were available to answer questions about the methods they used and the challenges they faced. Luis von Ahn presented the state-of-the-art in CAPTCHA research. CAPTCHAs are simple intelligence challenges that are intended to be easy for humans to solve, but difficult for robots. CAPTCHAs are in widespread use on the Internet to keep robots out of &ldquo;human-only&rdquo; areas. Larry Hunter discussed emerging new challenges in artificial intelligence applied to biology applications. Biology offers challenging problems &mdash; and the opportunity for AI to make a real and direct impact on people&rsquo;s lives. </p><p class="right"><i>John Riedl and Randy Hill</i></p><hr /><p>For further information about the IAAI 2003 Conference, consult the following:</p><ul><li><a href="http://www.aaai.org/Press/Proceedings/iaai03.php">Conference proceedings</a></li><li><a href="http://www.aaai.org/Library/IAAI/iaai03contents.php">List of papers</a> (with links to abstracts) presented at the conference.</li><li><a href="http://www.aaai.org/Conferences/IAAI/2003/iaai03-call.pdf"> Conference call for papers</a></li><li><a href="http://www.aaai.org/Conferences/IAAI/2003/iaai03-brochure.pdf">Conference brochure</a></li></ul><hr /><h3>Invited Speakers</h3><p></p><img height="150" width="100" src="http://www.aaai.org/Conferences/IAAI/Photos/friedland.jpg" alt="Noah Friedland" style="float: left; margin-right: 5px;" /><h5>Noah S. Friedland,<br />Vulcan, Inc.</h5><p><b>Project Halo: Toward a Digital Aristotle</b></p><p>Vulcan Inc. has launched a multistaged effort toward the creation of a digital Aristotle, an application capable of answering and providing cogent explanations to arbitrary questions in an ever-growing number of domains. The pilot phase was a six-month effort intended to investigate the state of the art in question answering, with an emphasis on deep reasoning. Friedland's talk will discuss the Halo vision and methodology and provide an overview of the pilot phase and its challenge. Friedland will also outline a road map for future phases of their initiative. </p><hr /><img height="121" width="100" src="http://www.aaai.org/Conferences/IAAI/Photos/hunter.jpg" alt="Lawrence Hunter" style="float: left; margin-right: 5px;" /><h5>Lawrence Hunter, <br />University of Colorado Health Sciences Center</h5><p><b>AI and Molecular Biology: A Growing Success Story</b></p><p>Applications of artificial intelligence in molecular biology have long been scientifically important, and are now growing in industrial significance as well. In application areas as diverse as drug discovery and health care cost containment, AI techniques from machine learning, knowledge representation, and now natural language processing are becoming increasingly part of mainstream commercial practice. In this lecture, Hunter describes some current success stories and outlines the potential for growth. </p><hr /><img height="103" width="100" src="http://www.aaai.org/Conferences/IAAI/Photos/ahn.jpg" alt="Luis von Ahn" style="float: left; margin-right: 5px;" /><h5>Luis von Ahn<br /> Carnegie Mellon University</h5> <p><b>CAPTCHA: Telling Humans and Computers Apart Automatically</b></p><p> A CAPTCHA is a program that can tell whether its user is a human or a computer. More specifically, a CAPTCHA is a program that can generate and grade tests that humans can pass but current computer programs cannot. CAPTCHAs have several applications in practical security and some results of this project are currently in use by Yahoo, Hotmail, and other major web sites. CAPTCHAs also provide concrete, well-defined challenges to the Artificial Intelligence community. Ahn describes the CAPTCHAproject in detail and surveys the many issues related to AI. </p><div class="hr1"><hr /></div></div></div></div><div id="left">
<div id="box4">
