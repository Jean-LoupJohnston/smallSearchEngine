...
<title>IAAI-08: The Twentieth Conference on Innovative Applications of Artificial Intelligence</title>
...
<div id="logo">
<h1>The Twentieth Conference on Innovative Applications of Artificial Intelligence</h1>
</div>
<!-- begin search -->
<div id="search">
...
The Twentieth Conference on Innovative Applications of Artificial Intelligence</span></h2>
<div class="content">

<p><i>Sponsored by the Association for the Advancement of Artificial Intelligence</i></p>

<p>AAAI was delighted to announce that the Twentieth IAAI Conference on Artificial Intelligence was held at the Hyatt Regency McCormick Place in Chicago, Illinois, July 13&ndash;17, 2008.  The purpose of the IAAI-08 conference was to promote research in AI and scientific exchange among AI researchers, practitioners, scientists, and engineers in related disciplines.  The program chair of IAAI-08 was Mehmet Goker. Karen Haigh served as program cochair.</p>

<div class="hr1">
<hr />
</div>
<h3 class="text2">IAAI-08 Program Committee</h3>

<p>Mehmet H. Goker, Chair (PricewaterhouseCoopers)<br />
Karen Haigh, Cochair (BBN)</p>

<p>William Cheetham (General Electric)<br />
Mike Hewett (Evincii)<br />
Randall Hill (USC Institute for Creative Technologies)<br />
Neil Jacobstein (Teknowledge)<br />
Bruce Porter (University of Texas at Austin)<br />
Elaine Rich (University of Texas at Austin)<br />
Nestor Rychtyckyj (Ford Motor Company)<br />
Ted Senator (SAIC)<br />
Howard Shrobe (Massachusetts Institute of Technology)<br />
Reid Smith (Marathon Oil Corporation)<br />
Ramasamy Uthurusamy (General Motors Corporation)<br />
Hector Munoz-Avila (Lehigh University)<br />
Daniel Shapiro (ISLE)<br />
Michael Youngblood (University of Carolina at Charlotte)<br />
Yolanda Gil (University of Southern California, Information Sciences Institute)<br />
Francesco Ricci (Free University of Bozen-Bolzano)<br />
Hideo Shimazu (NEC System Technologies)</p>

<h3 class="text2">The Conference Venue</h3>
<p>Chicago is one of the nation's greatest cities. Called "the pulse of America" by Sarah Bernhardt, Chicago has been a crucible of innovation. It was therefore quite fitting that this city was the site of IAAI-08.</p>
<p>AAAI reserved a block of rooms at the Hyatt Regency McCormick Place at reduced conference rates.</p>

<h3 class="text2">For More Information</h3>
<p>For further information about the IAAI 2008 Conference, consult the following:</p>
<ul>
<li><a href="http://www.aaai.org/Conferences/IAAI/2008/iaai08call.pdf">Conference call for papers</a></li>
<li><a href="http://www.aaai.org/Conferences/AAAI/2008/aaai08program.pdf">Conference program</a></li>
<li><a href="../../Press/Proceedings/aaai08.php">Conference proceedings</a></li>
<li><a href="http://www.aaai.org/Library/IAAI/iaai08contents.php">List of papers</a> (with links to abstracts) presented at the conference.</li> 
</ul>
