...
<title>IAAI-90: The Second Conference on Innovative Applications of Artificial Intelligence</title>
...
<div id="logo">
<h1>The Second Conference on Innovative Applications of Artificial Intelligence</h1>
</div>
<!-- begin search -->
<div id="search">
...
<div id="content" class="backgrnd4"><div id="right"><div id="box6"><h2 class="backgrnd12"><span class="text1">The Second Conference on Innovative Applications of Artificial Intelligence</span></h2><div class="content"><p><i>Sponsored by the Association for the Advancement of Artificial Intelligence</i></p><hr /><p> The Second Innovative Applications of Artificial Intelligence Conference was held May 1&ndash;3, 1990 at Georgetown University in Washington, D.C.</p> <p>The increasing complexity and global competitiveness of our everyday business environment necessitates the development of new computer technologies to reduce the gap between what needs to be done and what can effectively be addressed today. The wide spectrum of domains and tasks covered in this second conference on innovative applications demonstrates the role that AI can play in this challenging enterprise. AI is in transition: While academic research continues to progress, deployed applications demonstrate the utility of this new computer technology for encoding and manipulating knowledge. Applications have become a driving force in bringing AI into the mainstream, well integrated with existing computing environments, able to solve new problems, and able to adapt to evolving real-world requirements.</p><p> Innovative applications of AI might well be a euphemism. AI is itself innovative. However, by &ldquo;innovative,&rdquo; we mean those applications that represent the current frontier, from a technical, economic, or application domain perspective. They show how the technology can successfully be transferred and implemented in operational environments. These applications also directly contribute to demonstrating the role of AI techniques in a wider scope of human problems, encompassing both the soft and hard sciences.</p> <p>The applications selected for this conference support existing economic infrastructures (as in monitoring foreign exchange transactions, assisting in recruiting industrial personnel, or screening news stories). They also create the infrastructure elements of tomorrow (as in software validation or tunnel construction planning). It is the spectrum that can be the most significant: The individual applications are innovative, their sum even more so.</p> <p>The papers selected for this conference show the nature and range of real-world problems that AI technology can successfully address today. Once again, the proceedings of Innovative Applications of Artificial Intelligence constitutes a casebook of important points of reference in terms of technology, project management, design, integration, and deployment factors for anyone using AI techniques to increase productivity and competitiveness.</p><p class="right"><i>Alain Rappaport and Reid Smith</i></p><hr /><p>For further information about the IAAI 1990 Conference, consult the following:</p><ul><li><a href="http://www.aaai.org/Press/Proceedings/iaai90.php">Conference proceedings</a></li><li><a href="http://www.aaai.org/Library/IAAI/iaai90contents.php">List of papers</a> (with links to abstracts) presented at the conference.</li><li><a href="http://www.aaai.org/Conferences/IAAI/1990/iaai90-brochure.pdf"> Conference registration brochure</a></li></ul><div class="hr1"><hr /></div></div></div></div><div id="left">
<div id="box4">
