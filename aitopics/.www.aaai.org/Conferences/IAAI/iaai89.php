...
<title>IAAI-89: The First Conference on Innovative Applications of Artificial Intelligence</title>
...
<div id="logo">
<h1>The First Conference on Innovative Applications of Artificial Intelligence</h1>
</div>
<!-- begin search -->
<div id="search">
...
<div id="content" class="backgrnd4"><div id="right"><div id="box6"><h2 class="backgrnd12"><span class="text1">The First Conference on Innovative Applications of Artificial Intelligence</span></h2><div class="content"><p><i>Sponsored by the Association for the Advancement of Artificial Intelligence</i></p><hr /><p> The First Innovative Applications of Artificial Intelligence Conference was held March 28&ndash;30, 1989 at Stanford University in Stanford, California.</p><p>The emergence of scientific achievements from the field of artificial intelligence has triggered opportunities to tackle new problems in which the computer formerly had no role. If we have not achieved all the goals of automating cognition yet, our years of research are rewarded by what we feel can have a major impact on everyday operations in the workplace. </p><p>The AAAI Conference on Innovative Applications was organized by the Association for the Advancement of Artificial Intelligence to illustrate how the implications of AI research and development are starting to affect all areas of today&rsquo;s world, particularly those areas that concern commerce and industry. We feel such a forum can further the exchange of information on what really works and what the problems are as AI makes the transition from the research laboratory to industrial practice. We also believe tackling these new and innovative applications will lead to better technology because we will find and remedy current deficiencies when solving "real" problems.</p><p>A question we never fully resolved was what truly constitutes "innovative." For example, does innovative mean that an application must advance the state of the underlying AI technology? Or, must the application be a new unreported different one? Or, can the innovation be in the integration of AI with standard DP systems? At the current rate of development of this field, "innovation" itself has a changing definition. Some applications are likely to be the last of a first generation when developments were heroic acts and enterprises very difficult to reproduce. Most examples, however, illustrate how the use of AI technology has become not only effective but also economically feasible. They show the integration of AI into the standard DP environments as well as its introduction in the softer sciences and the management of human affairs beyond the more classic problems. </p><p>The sample selected from this year&rsquo;s application shows how AI has now successfully been applied to a wide spectrum of domains and tasks. We believe we have selected an interesting group of results from many submitted papers. To many applications in the making, and to those of great interest, we have suggested that they resubmit for next year&rsquo;s conference. We hope our selections and this conference will contribute to what we all believe is a very significant technology.</p><p class="right"><i>Herb Schorr and Alain Rappaport</i></p><hr /><p>For further information about the IAAI 1989 Conference, consult the following:</p><ul><li><a href="http://www.aaai.org/Press/Proceedings/iaai89.php">Conference proceedings</a></li><li><a href="http://www.aaai.org/Library/IAAI/iaai89contents.php">List of papers</a> (with links to abstracts) presented at the conference.</li></ul><div class="hr1"><hr /></div></div></div></div><div id="left">
<div id="box4">
