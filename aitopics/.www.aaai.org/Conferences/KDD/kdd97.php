...
<title>The Third International Conference on Knowledge Discovery and Data Mining (KDD 97)</title>
...
<div id="logo">
<h1>The Third International Conference on Knowledge Discovery and Data Mining (KDD 97)</h1>
</div>
<!-- begin search -->
<div id="search">
...
<div id="content" class="backgrnd4"><div id="right"><div id="box6"><h2 class="backgrnd12"><span class="text1">The Third International Conference on Knowledge Discovery and Data Mining</span></h2><div class="content"><p><i>Sponsored by the Association for the Advancement of Artificial Intelligence</i></p><hr /><img height="114" width="83" src="http://www.aaai.org/Conferences/KDD/1997/kdd97.gif" alt="KDD Logo" style="float: left; margin-right: 5px;" /><p>The Third International Conference on Knowledge Discovery and Data Mining (KDD-96) was held August 14&ndash;17, 1997, Newport Beach, California</h3><p>The rapid growth of data and information has created a need and anopportunity for extracting knowledge from databases, and bothresearchers and application developers have been responding to thatneed. Knowledge discovery in databases (KDD), also referred to as datamining, is an area of common interest to researchers in machinediscovery, statistics, databases, knowledge acquisition, machinelearning, data visualization, high performance computing, andknowledge-based systems. KDD applications have been developed forastronomy, biology, finance, insurance, marketing, medicine, and manyother fields. The third international conference on knowledge discoveryand data mining (KDD-97) will follow up the success of KDD-95 and KDD-96by bringing together researchers and application developers fromdifferent areas focusing on unifying themes.</p> <hr /><h3>The Conference</h3> <p>For furtherinformation about the KDD 1997 Conference, consult the following:</p><ul><li><a href="http://www.aaai.org/Conferences/KDD/1997/kdd97call.pdf"> Call for Papers</a></li><li><a href="http://www.aaai.org/Conferences/KDD/1997/kdd97brochure.pdf"> Conference Registration Brochure</a></li><li><a href="http://www.aaai.org/Conferences/KDD/1997/kdd97program.pdf"> Conference Program</a></li><li><a href="http://www.aaai.org/Press/Proceedings/kdd97.php">Proceedings</a></li><li><a href="http://www.aaai.org/Conferences/KDD/1997/kdd97onsite.pdf"> Registration Form</a></li></ul> <hr /> <h3>Workshop</h3><p>One workshop was held on Sunday, August 17 from 8:30 AM - 5:00 pm. Admission to the workshops was by invitation only; registration forms were sent to the accepted participants. There was an additional registration fee of $100, which covered the workshop sessions, preprints and coffee breaks.</p> <ul><li>Workshop on Issues in the Integration of Data Mining and Data Visualization</li></ul></div></div></div><div id="left">
<div id="box4">
