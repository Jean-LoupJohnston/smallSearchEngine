...
<title>The International Conference on Knowledge Discovery and Data Mining (KDD 98)</title>
...
<div id="logo">
<h1>The International Conference on Knowledge Discovery and Data Mining (KDD 98)</h1>
</div>
<!-- begin search -->
<div id="search">
...
<div id="content" class="backgrnd4"><div id="right"><div id="box6"><h2 class="backgrnd12"><span class="text1">The International Conference on Knowledge Discovery and Data Mining</span></h2><div class="content"><img height="123" width="150" src="http://www.aaai.org/Conferences/KDD/Photos/kdd.gif" alt="KDD Logo" style="float: left; margin-right: 5px;" /><p><i>Sponsored by the Association for the Advancement of Artificial Intelligence</i></p><p>Knowledge discovery in databases (KDD), also referred to as data mining, is an area of common interest to researchers in machine discovery, statistics, databases, knowledge acquisition, machine learning, data visualization, high performance computing, and knowledge-based systems. The International Conference on Knowledge Discovery and Data Mining, sponsored by AAAI, brings together researchers and application developers from different areas focusing on unifying themes.</p><hr /><h3>Past KDD Conferences</h3> <p class="left">|&nbsp;<a href="kdd98.php">KDD-98</a>&nbsp;|&nbsp; <a href="kdd97.php">KDD-97</a>&nbsp;|&nbsp; <a href="kdd96.php">KDD-96</a>&nbsp;|&nbsp; <a href="kdd95.php">KDD-95</a>&nbsp;|</p><hr /> <h3 class="left">Proceedings of the International Conference on Knowledge Discovery and Data Mining</h3> <ul> <li><i><a href="http://www.aaai.org/Press/Proceedings/kdd95.php">Proceedings of the First International Conference on Knowledge Discovery and Data Mining</a></i><br /> Edited by U. M. Fayyad and R. Uthurusamy </li>  <li><i><a href="http://www.aaai.org/Press/Proceedings/kdd96.php">Proceedings of the Second International Conference on Knowledge Discovery and Data Mining</a></i><br /> Edited by Evangelos Simoudis, Jiawei Han, &amp; Usama Fayyad </li> <li><i><a href="http://www.aaai.org/Press/Proceedings/kdd97.php">Proceedings of the Third International Conference on Knowledge Discovery and Data Mining</a></i><br /> Edited by Evangelos Simoudis, Jiawei Han, &amp; Usama Fayyad </li> <li><i><a href="http://www.aaai.org/Press/Proceedings/kdd98.php">Proceedings of the Fourth International Conference on Knowledge Discovery and Data Mining</a></i><br /> Rakesh Agrawal and Paul Stolorz; Gregory Piatetsky, General Chair </li> </ul> </div></div></div><div id="left">
<div id="box4">
