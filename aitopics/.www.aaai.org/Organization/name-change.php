...
<div id="right">
<div id="box6">
<h2 class="backgrnd12"><span class="text1">AAAI Is Now the Association for the Advancement of Artificial Intelligence</span></h2>
<div class="content"> 
<p>

As our world becomes smaller, scientific communities are becoming increasingly international. National scientific societies are evolving to serve their international constituencies, and in doing so, have come to reconsider their roles, their purposes, their images, their identities, their &ldquo;branding,&rdquo; and, consequently, their names. This is such an occasion for AAAI as it embarks on its second quarter century.
</p><p>AAAI&rsquo;s membership has strong international representation. The same is true of the contributors to, and attendees of, AAAI, and AAAI-sponsored, conferences, symposia, tutorials, and workshops. A large fraction of our membership and an even larger fraction of conference paper submissions are from authors based outside the U.S. Beyond the annual conferences held in North America, much of AAAI&rsquo;s mission, activities, and membership are not well-characterized by the label &ldquo;American.&rdquo; In short, our original name does not reflect our dual roles, national and international, in the global AI community.
</p><p>Following this line of reasoning, the AAAI Executive Committee recommended changing the name of our organization from the &ldquo;American Association for Artificial Intelligence&rdquo; to the &ldquo;Association for the Advancement of Artificial Intelligence.&rdquo; This proposal drops the adjective &ldquo;American&rdquo; from the organization&rsquo;s name but retains the AAAI abbreviation, logo, and &ldquo;brand.&rdquo; More importantly, the mission of the organization does not change. The new name simply reflects current reality and removes potential limitations imposed by the old name as we move forward in an increasingly global scientific environment. We have consulted with many of our sibling AI societies. We have no plans to change the scope or location of our activities as a consequence of the name change. 
</p><p>The proposal initially received enthusiastic support from the AAAI Executive Council (unanimous with one abstention), and the Strategic Planning Committee, consisting of all past presidents and current presidential officers of AAAI. We then put it to a vote of the membership, which approved the proposal. The Executive Council has subsequently unanimously endorsed the name change.
</p><p>The membership at large shares our enthusiasm for this exciting new face for AAAI. We have complied with the regulations governing organizations such as AAAI in carrying out this name change. I would like, in particular, to thank our Executive Director, Carol Hamilton, and all our staff, for taking on the additional burden of executing the name change proposal in addition to all their regular duties. So I am delighted to report that, effective March 1, 2007, AAAI is now the Association for the Advancement of Artificial Intelligence.
</p><p>&ndash; Alan K. Mackworth<br />
			President, AAAI (2005&ndash;2007)</p>
