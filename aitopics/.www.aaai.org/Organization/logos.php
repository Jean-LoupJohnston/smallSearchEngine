...
<title>AAAI Corporate Logos</title>
...
<div id="logo">
<h1>Association for the Advancement of Artificial Intelligence Logos</h1>
</div>
<!-- begin search -->
<div id="search">
...
<div id="right">
<div id="box6">
<h2 class="backgrnd12"><span class="text1">AAAI Logos</span></h2>
<div class="content">
<p>AAAI Workshop and Symposium organizers are invited to use these logos for use on their AAAI event websites and in the materials that will be produced for their AAAI-sponsored event. In addition, organizers of conferences that have received AAAI sponsorship or cooperation are invited to display the AAAI logo in conjunction with the listing of AAAI as a sponsor or cooperation partner. Logos for black and white and color printing are provided in encapsulated PostScript form. A jpeg version (in color) is also included for use on websites for AAAI workshops, symposia, and in cooperation events. No other use, without permission, of these logos may be made. </p><p><b>The AAAI logo is a registered trademark of the Association for the Advancement of Artificial Intelligence, a California Corporation.</b> Do not use these logos without permission. Do not alter the AAAI logo. It is our trademark.</p>

<div class="hr1">
<hr />
</div>

<h3>AAAI Logos for Use on Websites</h3>
<ul>
<li><a href="http://www.aaai.org/Organization/Logos/aaai-logo.jpg">Color Logo for Use on Websites (jpg)</a></li>
<li><a href="http://www.aaai.org/Organization/Logos/AAAI-Logo-with-Association-Name.jpg">AAAI Logo with Association Name (jpg)</a></li>
</ul>

<h3>AAAI Logos for Use on Printed Materials</h3>

<ul><li><a href="http://www.aaai.org/Organization/Logos/aaai-logo.eps">Color Logo (eps)</a></li>
<li><a href="http://www.aaai.org/Organization/Logos/aaai-logo-bw.eps">Black and White Logo (eps)</a></li>
</ul>
